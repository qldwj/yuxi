...
public final class VersionTable {
    ...
    public static int getVersion(SQLiteDatabase sQLiteDatabase, int i2, String str) throws DatabaseIOException {
        try {
            ...
            Cursor cursorQuery = sQLiteDatabase.query(TABLE_NAME, new String[]{COLUMN_VERSION}, WHERE_FEATURE_AND_INSTANCE_UID_EQUALS, featureAndInstanceUidArguments(i2, str), null, null, null);
            try {
    ...
    public static void removeVersion(SQLiteDatabase sQLiteDatabase, int i2, String str) throws DatabaseIOException {
        try {
            if (Util.tableExists(sQLiteDatabase, TABLE_NAME)) {
                sQLiteDatabase.delete(TABLE_NAME, WHERE_FEATURE_AND_INSTANCE_UID_EQUALS, featureAndInstanceUidArguments(i2, str));
            }
        } catch (SQLException e10) {
            throw new DatabaseIOException(e10);
        }
    ...
    public static void setVersion(SQLiteDatabase sQLiteDatabase, int i2, String str, int i10) throws DatabaseIOException {
        try {
            sQLiteDatabase.execSQL(SQL_CREATE_TABLE_IF_NOT_EXISTS);
            ContentValues contentValues = new ContentValues();
            contentValues.put(COLUMN_FEATURE, Integer.valueOf(i2));
            contentValues.put(COLUMN_INSTANCE_UID, str);
            contentValues.put(COLUMN_VERSION, Integer.valueOf(i10));
