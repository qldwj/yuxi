...
public abstract class DownloadService extends Service {
    ...
    public static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new k(this, 0, downloadService));
            }
        }
        ...
        public void onWaitingForRequirementsChanged(DownloadManager downloadManager, boolean z9) {
            if (z9 || downloadManager.getDownloadsPaused() || !serviceMayNeedRestart()) {
                return;
            }
        ...
        private DownloadManagerHelper(Context context, DownloadManager downloadManager, boolean z9, Scheduler scheduler, Class<? extends DownloadService> cls) {
    ...
    public final class ForegroundNotificationUpdater {
        ...
        public ForegroundNotificationUpdater(int i2, long j10) {
        ...
        public void update() {
            ...
            if (this.periodicUpdatesStarted) {
                ...
                this.handler.postDelayed(new l(0, this), this.updateInterval);
            }
        }
    ...
    public static Intent buildAddDownloadIntent(Context context, Class<? extends DownloadService> cls, DownloadRequest downloadRequest, boolean z9) {
        return buildAddDownloadIntent(context, cls, downloadRequest, 0, z9);
    }

    public static Intent buildPauseDownloadsIntent(Context context, Class<? extends DownloadService> cls, boolean z9) {
        return getIntent(context, cls, ACTION_PAUSE_DOWNLOADS, z9);
    }

    public static Intent buildRemoveAllDownloadsIntent(Context context, Class<? extends DownloadService> cls, boolean z9) {
        return getIntent(context, cls, ACTION_REMOVE_ALL_DOWNLOADS, z9);
    }

    public static Intent buildRemoveDownloadIntent(Context context, Class<? extends DownloadService> cls, String str, boolean z9) {
        return getIntent(context, cls, ACTION_REMOVE_DOWNLOAD, z9).putExtra(KEY_CONTENT_ID, str);
    }

    public static Intent buildResumeDownloadsIntent(Context context, Class<? extends DownloadService> cls, boolean z9) {
        return getIntent(context, cls, ACTION_RESUME_DOWNLOADS, z9);
    }

    public static Intent buildSetRequirementsIntent(Context context, Class<? extends DownloadService> cls, Requirements requirements, boolean z9) {
        return getIntent(context, cls, ACTION_SET_REQUIREMENTS, z9).putExtra(KEY_REQUIREMENTS, requirements);
    }

    public static Intent buildSetStopReasonIntent(Context context, Class<? extends DownloadService> cls, String str, int i2, boolean z9) {
        return getIntent(context, cls, ACTION_SET_STOP_REASON, z9).putExtra(KEY_CONTENT_ID, str).putExtra(KEY_STOP_REASON, i2);
    }
    ...
    private static Intent getIntent(Context context, Class<? extends DownloadService> cls, String str, boolean z9) {
        return getIntent(context, cls, str).putExtra(KEY_FOREGROUND, z9);
    }
    ...
    public static void sendAddDownload(Context context, Class<? extends DownloadService> cls, DownloadRequest downloadRequest, boolean z9) {
        startService(context, buildAddDownloadIntent(context, cls, downloadRequest, z9), z9);
    }

    public static void sendPauseDownloads(Context context, Class<? extends DownloadService> cls, boolean z9) {
        startService(context, buildPauseDownloadsIntent(context, cls, z9), z9);
    }

    public static void sendRemoveAllDownloads(Context context, Class<? extends DownloadService> cls, boolean z9) {
        startService(context, buildRemoveAllDownloadsIntent(context, cls, z9), z9);
    }

    public static void sendRemoveDownload(Context context, Class<? extends DownloadService> cls, String str, boolean z9) {
        startService(context, buildRemoveDownloadIntent(context, cls, str, z9), z9);
    }

    public static void sendResumeDownloads(Context context, Class<? extends DownloadService> cls, boolean z9) {
        startService(context, buildResumeDownloadsIntent(context, cls, z9), z9);
    }

    public static void sendSetRequirements(Context context, Class<? extends DownloadService> cls, Requirements requirements, boolean z9) {
        startService(context, buildSetRequirementsIntent(context, cls, requirements, z9), z9);
    }

    public static void sendSetStopReason(Context context, Class<? extends DownloadService> cls, String str, int i2, boolean z9) {
        startService(context, buildSetStopReasonIntent(context, cls, str, i2, z9), z9);
    }
    ...
    public void onCreate() {
        ...
        if (downloadManagerHelper == null) {
            ...
            Scheduler scheduler = (z9 && (Util.SDK_INT < 31)) ? getScheduler() : null;
            DownloadManager downloadManager = getDownloadManager();
            downloadManager.resumeDownloads();
            DownloadManagerHelper downloadManagerHelper2 = new DownloadManagerHelper(getApplicationContext(), downloadManager, z9, scheduler, cls);
    ...
    public static Intent buildAddDownloadIntent(Context context, Class<? extends DownloadService> cls, DownloadRequest downloadRequest, int i2, boolean z9) {
        return getIntent(context, cls, ACTION_ADD_DOWNLOAD, z9).putExtra(KEY_DOWNLOAD_REQUEST, downloadRequest).putExtra(KEY_STOP_REASON, i2);
    }
    ...
    public DownloadService(int i2, long j10, String str, int i10, int i11) {
        if (i2 == 0) {
        ...
        this.foregroundNotificationUpdater = new ForegroundNotificationUpdater(i2, j10);
        this.channelId = str;
        this.channelNameResourceId = i10;
        this.channelDescriptionResourceId = i11;
    }

    public static void sendAddDownload(Context context, Class<? extends DownloadService> cls, DownloadRequest downloadRequest, int i2, boolean z9) {
        startService(context, buildAddDownloadIntent(context, cls, downloadRequest, i2, z9), z9);
    }
}
