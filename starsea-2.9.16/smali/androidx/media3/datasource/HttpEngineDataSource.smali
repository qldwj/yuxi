...
# direct methods
.method public constructor <init>(Landroid/net/http/HttpEngine;Ljava/util/concurrent/Executor;IIIZZLjava/lang/String;Landroidx/media3/datasource/HttpDataSource$RequestProperties;Lb7/g;Z)V
    .locals 1
    .annotation build Landroidx/media3/common/util/UnstableApi;
    .end annotation
    ...
    .line 9
    invoke-static {p1}, Landroidx/media3/datasource/b;->d(Ljava/lang/Object;)Landroid/net/http/HttpEngine;
    ...
    .line 36
    .line 37
    iput-object p10, p0, Landroidx/media3/datasource/HttpEngineDataSource;->contentTypePredicate:Lb7/g;
...
.method private buildRequestBuilder(Landroidx/media3/datasource/DataSpec;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 10
    .line 11
    invoke-static {v0, v1, v2, p2}, Landroidx/media3/datasource/b;->f(Landroid/net/http/HttpEngine;Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 16
    .line 17
    invoke-static {p2, v0}, Landroidx/media3/datasource/b;->h(Landroid/net/http/UrlRequest$Builder;I)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 21
    invoke-static {p2}, Landroidx/media3/datasource/b;->g(Landroid/net/http/UrlRequest$Builder;)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 86
    .line 87
    invoke-static {p2, v3, v2}, Landroidx/media3/datasource/b;->q(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 131
    .line 132
    invoke-static {p2, v0}, Landroidx/media3/datasource/b;->p(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)V
    ...
    .line 154
    .line 155
    invoke-static {p2, v0, p1}, Landroidx/media3/datasource/b;->o(Landroid/net/http/UrlRequest$Builder;Landroid/net/http/UploadDataProvider;Ljava/util/concurrent/Executor;)V
...
.method private buildRequestWrapper(Landroidx/media3/datasource/DataSpec;)Landroidx/media3/datasource/HttpEngineDataSource$UrlRequestWrapper;
    ...
    .line 13
    invoke-static {p1}, Landroidx/media3/datasource/b;->i(Landroid/net/http/UrlRequest$Builder;)Landroid/net/http/UrlRequest;
...
.method private static isCompressed(Landroid/net/http/UrlResponseInfo;)Z
    ...
    .line 1
    invoke-static {p0}, Landroidx/media3/datasource/b;->c(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;
    ...
    .line 5
    invoke-static {p0}, Landroidx/media3/datasource/b;->l(Landroid/net/http/HeaderBlock;)Ljava/util/List;
...
.method public getResponseHeaders()Ljava/util/Map;
    ...
    .line 8
    :cond_0
    invoke-static {v0}, Landroidx/media3/datasource/b;->c(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;
    ...
    .line 12
    invoke-static {v0}, Landroidx/media3/datasource/b;->m(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
...
.method public open(Landroidx/media3/datasource/DataSpec;)J
    ...
    .line 89
    invoke-static {v0}, Landroidx/media3/datasource/b;->j(Ljava/lang/Object;)Landroid/net/http/UrlResponseInfo;
    ...
    .line 101
    invoke-static {v4}, Landroidx/media3/datasource/b;->m(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    .line 120
    :cond_2
    iget-object v12, v1, Landroidx/media3/datasource/HttpEngineDataSource;->contentTypePredicate:Lb7/g;
    ...
    .line 131
    .line 132
    invoke-interface {v12, v13}, Lb7/g;->apply(Ljava/lang/Object;)Z
    ...
    .line 261
    .line 262
    invoke-static {v0}, Landroidx/media3/datasource/b;->k(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
