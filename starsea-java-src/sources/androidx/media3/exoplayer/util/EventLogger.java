...
public class EventLogger implements AnalyticsListener {
    ...
    private String getEventString(AnalyticsListener.EventTime eventTime, String str, String str2, Throwable th) {
        String strP = str + " [" + getEventTimeString(eventTime);
        if (th instanceof PlaybackException) {
            strP = strP + ", errorCode=" + ((PlaybackException) th).getErrorCodeName();
        }
        if (str2 != null) {
            strP = b.P(strP, ", ", str2);
        }
    ...
    public void onAudioUnderrun(AnalyticsListener.EventTime eventTime, int i2, long j10, long j11) {
        loge(eventTime, "audioTrackUnderrun", i2 + ", " + j10 + ", " + j11, null);
    }
    ...
    public void onIsLoadingChanged(AnalyticsListener.EventTime eventTime, boolean z9) {
        logd(eventTime, "loading", Boolean.toString(z9));
    }

    @Override // androidx.media3.exoplayer.analytics.AnalyticsListener
    @UnstableApi
    public void onIsPlayingChanged(AnalyticsListener.EventTime eventTime, boolean z9) {
        logd(eventTime, "isPlaying", Boolean.toString(z9));
    }
    ...
    @Override // androidx.media3.exoplayer.analytics.AnalyticsListener
    @UnstableApi
    public void onPlayWhenReadyChanged(AnalyticsListener.EventTime eventTime, boolean z9, int i2) {
        logd(eventTime, "playWhenReady", z9 + ", " + getPlayWhenReadyChangeReasonString(i2));
    }
    ...
    public void onSkipSilenceEnabledChanged(AnalyticsListener.EventTime eventTime, boolean z9) {
        logd(eventTime, "skipSilenceEnabled", Boolean.toString(z9));
    }

    @Override // androidx.media3.exoplayer.analytics.AnalyticsListener
    @UnstableApi
    public void onSurfaceSizeChanged(AnalyticsListener.EventTime eventTime, int i2, int i10) {
        logd(eventTime, "surfaceSize", i2 + ", " + i10);
    }
    ...
    public void onTracksChanged(AnalyticsListener.EventTime eventTime, Tracks tracks) {
        ...
        for (int i11 = 0; !z9 && i11 < groups.size(); i11++) {
            ...
            for (int i12 = 0; !z9 && i12 < group2.length; i12++) {
    ...
    public void onDrmSessionAcquired(AnalyticsListener.EventTime eventTime, int i2) {
        logd(eventTime, "drmSessionAcquired", j0.v(i2, "state="));
    }
