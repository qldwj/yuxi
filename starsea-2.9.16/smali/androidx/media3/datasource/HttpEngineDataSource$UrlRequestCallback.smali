...
.method public declared-synchronized onFailed(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Landroid/net/http/HttpException;)V
    ...
    .line 13
    .line 14
    invoke-static {p3}, Landroidx/media3/datasource/b;->e(Ljava/lang/Object;)Landroid/net/http/NetworkException;
...
.method public declared-synchronized onRedirectReceived(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Ljava/lang/String;)V
    ...
    .line 41
    .line 42
    invoke-static {p2}, Landroidx/media3/datasource/b;->k(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
    ...
    .line 46
    invoke-static {p2}, Landroidx/media3/datasource/b;->c(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;
    ...
    .line 50
    invoke-static {p2}, Landroidx/media3/datasource/b;->m(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    .line 120
    .line 121
    invoke-static {p1}, Landroidx/media3/datasource/b;->r(Landroid/net/http/UrlRequest;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
