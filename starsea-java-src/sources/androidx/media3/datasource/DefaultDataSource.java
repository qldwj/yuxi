...
public final class DefaultDataSource implements DataSource {
    ...
    public int read(byte[] bArr, int i2, int i10) throws IOException {
        return ((DataSource) Assertions.checkNotNull(this.dataSource)).read(bArr, i2, i10);
    }

    @UnstableApi
    public DefaultDataSource(Context context, String str, boolean z9) {
        this(context, str, 8000, 8000, z9);
    }

    @UnstableApi
    public DefaultDataSource(Context context, String str, int i2, int i10, boolean z9) {
        this(context, new DefaultHttpDataSource.Factory().setUserAgent(str).setConnectTimeoutMs(i2).setReadTimeoutMs(i10).setAllowCrossProtocolRedirects(z9).createDataSource());
    }
