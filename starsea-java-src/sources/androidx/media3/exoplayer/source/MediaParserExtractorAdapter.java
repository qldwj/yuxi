...
public final class MediaParserExtractorAdapter implements ProgressiveMediaExtractor {
    ...
    @Deprecated
    public static final ProgressiveMediaExtractor.Factory FACTORY = new l(4);
    ...
    public static final class Factory implements ProgressiveMediaExtractor.Factory {
        ...
        public void setConstantBitrateSeekingEnabled(boolean z9) {
            if (!z9) {
    ...
    public static /* synthetic */ ProgressiveMediaExtractor lambda$static$0(PlayerId playerId) {
        return new MediaParserExtractorAdapter(playerId, t1.f2594o);
    }
    ...
    public void seek(long j10, long j11) {
        ...
        this.mediaParser.seek(a4.f.j(a4.f.j(seekPoints.second).position == j10 ? seekPoints.second : seekPoints.first));
    }

    @Deprecated
    public MediaParserExtractorAdapter(PlayerId playerId) {
        this(playerId, t1.f2594o);
    }
