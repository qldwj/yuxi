...
public class w extends ImageButton {
    ...
    public final androidx.recyclerview.widget.b f12536i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public final a2.f0 f12537j;
    ...
    public final void drawableStateChanged() {
        ...
        androidx.recyclerview.widget.b bVar = this.f12536i;
        if (bVar != null) {
            bVar.a();
        }
        a2.f0 f0Var = this.f12537j;
        if (f0Var != null) {
            f0Var.b();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        return !(((ImageView) this.f12537j.f92k).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        a2.f0 f0Var = this.f12537j;
        if (f0Var != null && drawable != null && !this.f12538k) {
