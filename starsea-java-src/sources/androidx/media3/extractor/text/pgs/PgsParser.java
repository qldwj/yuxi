    ...
    public static final class CueBuilder {
        ...
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int i2) {
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                double d10 = unsignedByte4 - 128;
                this.colors[unsignedByte] = (Util.constrainValue((int) ((d2 - (0.34414d * d10)) - (d3 * 0.71414d)), 0, 255) << 8) | (parsableByteArray.readUnsignedByte() << 24) | (Util.constrainValue((int) ((1.402d * d3) + d2), 0, 255) << 16) | Util.constrainValue((int) ((d10 * 1.772d) + d2), 0, 255);
            }
            this.colorsSet = true;
        }
            ...
            while (i10 < i2) {
                ...
                if (unsignedByte2 != 0) {
                    ...
                    if (unsignedByte3 != 0) {
                        ...
                        Arrays.fill(iArr, i10, unsignedByte, (unsignedByte3 & 128) == 0 ? this.colors[0] : this.colors[this.bitmapData.readUnsignedByte()]);
                    }
                }
                i10 = unsignedByte;
            }
