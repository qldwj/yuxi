...
final class TsBinarySearchSeeker extends BinarySearchSeeker {
    ...
    public static final class TsPcrSeeker implements BinarySearchSeeker.TimestampSeeker {
        ...
        public TsPcrSeeker(int i2, TimestampAdjuster timestampAdjuster, int i10) {
            this.pcrPid = i2;
    ...
    public TsBinarySearchSeeker(TimestampAdjuster timestampAdjuster, long j10, long j11, int i2, int i10) {
        super(new BinarySearchSeeker.DefaultSeekTimestampConverter(), new TsPcrSeeker(i2, timestampAdjuster, i10), j10, 0L, j10 + 1, 0L, j11, 188L, MINIMUM_SEARCH_RANGE_BYTES);
    }
}
