...
.method public constructor <init>(ILandroidx/media3/common/Format;Ljava/util/List;Landroidx/media3/exoplayer/analytics/PlayerId;)V
    ...
    .line 40
    .line 41
    invoke-static {p1, v0}, La4/f;->l(Ljava/lang/String;Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;)Landroid/media/MediaParser;
    ...
    .line 46
    .line 47
    invoke-static {p1}, La4/f;->A(Landroid/media/MediaParser;)V

    .line 48
    .line 49
    .line 50
    invoke-static {p1}, La4/f;->y(Landroid/media/MediaParser;)V

    .line 51
    .line 52
    .line 53
    invoke-static {p1}, La4/f;->z(Landroid/media/MediaParser;)V

    .line 54
    .line 55
    .line 56
    invoke-static {p1}, La4/f;->x(Landroid/media/MediaParser;)V

    .line 57
    .line 58
    .line 59
    invoke-static {p1}, La4/f;->B(Landroid/media/MediaParser;)V

    .line 60
    .line 61
    .line 62
    invoke-static {p1}, La4/f;->C(Landroid/media/MediaParser;)V

    .line 63
    .line 64
    .line 65
    invoke-static {p1}, La4/f;->D(Landroid/media/MediaParser;)V
    ...
    .line 97
    .line 98
    invoke-static {p2, p1}, La4/f;->u(Landroid/media/MediaParser;Ljava/util/ArrayList;)V
...
.method private maybeExecutePendingSeek()V
    ...
    .line 21
    .line 22
    invoke-static {v0, v1, v2}, La4/f;->m(Landroid/media/MediaParser$SeekMap;J)Landroid/util/Pair;
    ...
    .line 32
    invoke-static {v5, v0}, La4/f;->r(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekPoint;)V
...
.method public read(Landroidx/media3/extractor/ExtractorInput;)Z
    ...
    .line 16
    .line 17
    invoke-static {p1, v0}, La4/f;->v(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekableInputReader;)Z
