...
public final class Mp3Extractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new b(29);
    private static final Id3Decoder.FramePredicate REQUIRED_ID3_FRAME_PREDICATE = new a(0);
    ...
    private Seeker getConstantBitrateSeeker(ExtractorInput extractorInput, boolean z9) throws IOException {
        extractorInput.peekFully(this.scratch.getData(), 0, 4);
        this.scratch.setPosition(0);
        this.synchronizedHeader.setForHeaderData(this.scratch.readInt());
        return new ConstantBitrateSeeker(extractorInput.getLength(), extractorInput.getPosition(), this.synchronizedHeader, z9);
    }
    ...
    private static boolean headersMatch(int i2, long j10) {
        return ((long) (i2 & MPEG_AUDIO_HEADER_MASK)) == (j10 & (-128000));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$static$1(int i2, int i10, int i11, int i12, int i13) {
        if (i10 == 67 && i11 == 79 && i12 == 77 && (i13 == 77 || i2 == 2)) {
            return true;
        }
    ...
    private Seeker maybeReadSeekFrame(ExtractorInput extractorInput) throws IOException {
        ...
        if (!this.gaplessInfoHolder.hasGaplessInfo() && (i2 = xingFrame.encoderDelay) != -1 && (i10 = xingFrame.encoderPadding) != -1) {
    ...
    private boolean synchronize(ExtractorInput extractorInput, boolean z9) throws IOException {
        int peekPosition;
        int i2;
        int frameSize;
        ...
        while (true) {
            ...
            if ((i2 == 0 || headersMatch(i13, i2)) && (frameSize = MpegAudioUtil.getFrameSize(i13)) != -1) {
                i11++;
                if (i11 != 1) {
                    if (i11 == 4) {
                        break;
    ...
    private Seeker getConstantBitrateSeeker(long j10, XingFrame xingFrame, long j11) {
        ...
        return new ConstantBitrateSeeker(j13, j10 + ((long) xingFrame.header.frameSize), y8.a.F(Util.scaleLargeValue(j16, 8000000L, jComputeDurationUs, roundingMode)), y8.a.F(l.C(j16, xingFrame.frameCount, roundingMode)), false);
    }
