...
public final class e extends InputConnectionWrapper {
    ...
    public final /* synthetic */ n f3957a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(InputConnection inputConnection, n nVar) {
                ...
                try {
                    ...
                    if (uri != null && clipDescription != null) {
                        ...
                        if (Build.VERSION.SDK_INT >= 25) {
                            a0Var.f59i = new f(uri, clipDescription, uri2);
                        } else {
                            a0Var.f59i = new a2.f(uri, clipDescription, uri2, 6);
                        }
                        zC = nVar.c(a0Var, i2, bundle2);
                    }
