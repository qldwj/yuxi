...
public final class AacUtil {
    ...
    public static final class Config {
        ...
        private Config(int i2, int i10, String str) {
    ...
    public static byte[] buildAacLcAudioSpecificConfig(int i2, int i10) {
        int i11 = 0;
        int i12 = -1;
        int i13 = 0;
        while (true) {
        ...
        if (i2 == -1 || i14 == -1) {
            throw new IllegalArgumentException(j0.u(i2, i10, "Invalid sample rate or number of channels: ", ", "));
        }
        return buildAudioSpecificConfig(2, i12, i14);
    }

    public static byte[] buildAudioSpecificConfig(int i2, int i10, int i11) {
    ...
    private static void parseGaSpecificConfig(ParsableBitArray parsableBitArray, int i2, int i10) {
    ...
    public static Config parseAudioSpecificConfig(ParsableBitArray parsableBitArray, boolean z9) throws ParserException {
        int audioObjectType = getAudioObjectType(parsableBitArray);
        int samplingFrequency = getSamplingFrequency(parsableBitArray);
        int bits = parsableBitArray.readBits(4);
        String strV = j0.v(audioObjectType, CODECS_STRING_PREFIX);
        ...
        if (i2 != -1) {
            return new Config(samplingFrequency, i2, strV);
        }
