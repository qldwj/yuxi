...
public class PlaybackException extends Exception {
    ...
    public PlaybackException(String str, Throwable th, int i2) {
        this(str, th, i2, Bundle.EMPTY, Clock.DEFAULT.elapsedRealtime());
    }
    ...
    public PlaybackException(String str, Throwable th, int i2, Bundle bundle) {
        this(str, th, i2, bundle, Clock.DEFAULT.elapsedRealtime());
    }
    ...
    @UnstableApi
    public PlaybackException(String str, Throwable th, int i2, Bundle bundle, long j10) {
        super(str, th);
        this.errorCode = i2;
        this.extras = bundle;
