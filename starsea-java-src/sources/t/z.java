...
public final class z {
    ...
    public z(int i2) {
        this.f14797a = f0.f14723a;
        Object[] objArr = u.a.f15063c;
        this.f14798b = objArr;
        this.f14799c = objArr;
        if (i2 >= 0) {
            f(f0.f(i2));
    ...
    public final void a() {
        ...
        if (jArr != f0.f14723a) {
            k8.m.x0(jArr);
            long[] jArr2 = this.f14797a;
            int i2 = this.f14800d;
            int i10 = i2 >> 3;
            long j10 = 255 << ((i2 & 7) << 3);
            jArr2[i10] = (jArr2[i10] & (~j10)) | j10;
        }
        k8.m.w0(this.f14799c, 0, this.f14800d);
        k8.m.w0(this.f14798b, 0, this.f14800d);
        this.f14802f = f0.c(this.f14800d) - this.f14801e;
    }
    ...
    public final boolean b(Object obj) {
        ...
        loop0: while (true) {
            ...
            for (long j12 = (~j11) & (j11 - 72340172838076673L) & (-9187201950435737472L); j12 != 0; j12 &= j12 - 1) {
                ...
                if (w8.k.a(this.f14798b[iNumberOfTrailingZeros], obj)) {
                    break loop0;
                }
            }
    ...
    public final int d(Object obj) {
        ...
        while (true) {
            ...
            if ((((~j12) << 6) & j12 & (-9187201950435737472L)) != 0) {
                ...
                long j16 = 128;
                long j17 = 255;
                if (this.f14802f != 0 || ((this.f14797a[iC >> 3] >> ((iC & 7) << 3)) & 255) == 254) {
                    j10 = 128;
                    j11 = 255;
                } else {
                    int i24 = this.f14800d;
                    if (i24 <= 8 || Long.compare((((long) this.f14801e) * 32) ^ Long.MIN_VALUE, (((long) i24) * 25) ^ Long.MIN_VALUE) > 0) {
                        j10 = 128;
                        j11 = 255;
                        int iD = f0.d(this.f14800d);
                        long[] jArr3 = this.f14797a;
                        Object[] objArr2 = this.f14798b;
                        Object[] objArr3 = this.f14799c;
                        int i25 = this.f14800d;
                        f(iD);
                        long[] jArr4 = this.f14797a;
                        Object[] objArr4 = this.f14798b;
                        Object[] objArr5 = this.f14799c;
                        int i26 = this.f14800d;
                        int i27 = 0;
                        while (i27 < i25) {
                            if (((jArr3[i27 >> 3] >> ((i27 & 7) << 3)) & 255) < 128) {
                                ...
                                jArr[i29] = j19;
                                jArr[(((iC2 - 7) & i26) + (i26 & 7)) >> 3] = j19;
                                objArr4[iC2] = obj2;
                                objArr5[iC2] = objArr3[i27];
                            } else {
                                jArr = jArr4;
                            }
                            i27++;
                        ...
                        long[] jArr5 = this.f14797a;
                        int i31 = this.f14800d;
                        Object[] objArr6 = this.f14798b;
                        Object[] objArr7 = this.f14799c;
                        f0.a(jArr5, i31);
                        int i32 = 0;
                        int iB = -1;
                        while (i32 != i31) {
                            ...
                            if (j20 == j16) {
                                ...
                                int i38 = i37 & i31;
                                long j22 = j17;
                                if (((iC3 - i38) & i31) / 8 == ((i32 - i38) & i31) / 8) {
                                    ...
                                    if (((j23 >> i41) & j22) == j21) {
                                        ...
                                        objArr[iC3] = objArr[i39];
                                        objArr[i39] = null;
                                        objArr7[iC3] = objArr7[i39];
                                        objArr7[i39] = null;
                                        iB = i39;
                                        i2 = iB;
                                    } else {
                ...
                this.f14801e++;
                int i42 = this.f14802f;
                long[] jArr6 = this.f14797a;
                int i43 = iC >> 3;
                long j24 = jArr6[i43];
                int i44 = (iC & 7) << 3;
                if (((j24 >> i44) & j11) != j10) {
                ...
                this.f14802f = i42 - i19;
                int i45 = this.f14800d;
                long j25 = (j24 & (~(j11 << i44))) | (j13 << i44);
                jArr6[i43] = j25;
                jArr6[(((iC - 7) & i45) + (i45 & 7)) >> 3] = j25;
                return ~iC;
            }
            i16 += 8;
            i15 = (i15 + i16) & i14;
    ...
    public final Object e(Object obj) {
        ...
        loop0: while (true) {
            ...
            for (long j12 = (~j11) & (j11 - 72340172838076673L) & (-9187201950435737472L); j12 != 0; j12 &= j12 - 1) {
                iNumberOfTrailingZeros = ((Long.numberOfTrailingZeros(j12) >> 3) + i14) & i12;
                if (w8.k.a(this.f14798b[iNumberOfTrailingZeros], obj)) {
                    break loop0;
                }
            }
        ...
        if (iNumberOfTrailingZeros >= 0) {
            return this.f14799c[iNumberOfTrailingZeros];
        }
        return null;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        z zVar = (z) obj;
        if (zVar.f14801e != this.f14801e) {
            return false;
        }
        Object[] objArr = this.f14798b;
        Object[] objArr2 = this.f14799c;
        long[] jArr = this.f14797a;
    ...
    public final void f(int i2) {
        ...
        this.f14802f = f0.c(this.f14800d) - this.f14801e;
        this.f14798b = new Object[iMax];
        this.f14799c = new Object[iMax];
    }
    ...
    public final Object h(int i2) {
        ...
        this.f14798b[i2] = null;
        Object[] objArr = this.f14799c;
