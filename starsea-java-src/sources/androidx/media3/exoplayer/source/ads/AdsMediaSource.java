...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    public static final class AdLoadException extends IOException {
        ...
        public static AdLoadException createForAdGroup(Exception exc, int i2) {
            return new AdLoadException(1, new IOException(j0.v(i2, "Failed to load ad group "), exc));
        }
    ...
    public final class AdPrepareListener implements MaskingMediaPeriod.PrepareListener {
        ...
        public void onPrepareComplete(MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource.this.mainHandler.post(new d(this, 0, mediaPeriodId));
        }
        ...
        public void onPrepareError(MediaSource.MediaPeriodId mediaPeriodId, IOException iOException) {
            ...
            AdsMediaSource.this.mainHandler.post(new c(this, mediaPeriodId, iOException, 0));
        }
    }
    ...
    public final class ComponentListener implements AdsLoader.EventListener {
        ...
        public void onAdPlaybackState(AdPlaybackState adPlaybackState) {
            ...
            this.playerHandler.post(new d(this, 1, adPlaybackState));
        }
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (i10 < adMediaSourceHolderArr2.length) {
                    ...
                    jArr[i2][i10] = adMediaSourceHolder == null ? C.TIME_UNSET : adMediaSourceHolder.getDurationUs();
                    i10++;
                }
            }
            i2++;
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j10) {
        ...
        if (adMediaSourceHolderArr2.length <= i10) {
            adMediaSourceHolderArr[i2] = (AdMediaSourceHolder[]) Arrays.copyOf(adMediaSourceHolderArr2, i10 + 1);
        }
        AdMediaSourceHolder adMediaSourceHolder = this.adMediaSourceHolders[i2][i10];
        if (adMediaSourceHolder == null) {
            adMediaSourceHolder = new AdMediaSourceHolder(mediaPeriodId);
            this.adMediaSourceHolders[i2][i10] = adMediaSourceHolder;
            maybeUpdateAdMediaSources();
        }
