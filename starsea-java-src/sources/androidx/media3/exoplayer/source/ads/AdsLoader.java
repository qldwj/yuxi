...
public interface AdsLoader {
    ...
    @UnstableApi
    void handlePrepareComplete(AdsMediaSource adsMediaSource, int i2, int i10);

    @UnstableApi
    void handlePrepareError(AdsMediaSource adsMediaSource, int i2, int i10, IOException iOException);
