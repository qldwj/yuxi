...
public interface ShuffleOrder {
    ...
    public static class DefaultShuffleOrder implements ShuffleOrder {
        ...
        @Override // androidx.media3.exoplayer.source.ShuffleOrder
        public ShuffleOrder cloneAndInsert(int i2, int i10) {
        ...
        @Override // androidx.media3.exoplayer.source.ShuffleOrder
        public ShuffleOrder cloneAndRemove(int i2, int i10) {
            int i11 = i10 - i2;
        ...
        public int getNextIndex(int i2) {
            int i10 = this.indexInShuffled[i2] + 1;
            int[] iArr = this.shuffled;
            if (i10 < iArr.length) {
                return iArr[i10];
            }
        ...
        public DefaultShuffleOrder(int i2, long j10) {
            this(i2, new Random(j10));
        }
    ...
    public static final class UnshuffledShuffleOrder implements ShuffleOrder {
        ...
        @Override // androidx.media3.exoplayer.source.ShuffleOrder
        public ShuffleOrder cloneAndRemove(int i2, int i10) {
            return new UnshuffledShuffleOrder((this.length - i10) + i2);
        }
    ...
    ShuffleOrder cloneAndInsert(int i2, int i10);

    ShuffleOrder cloneAndRemove(int i2, int i10);
