...
public final class ec extends w8.l implements v8.g {

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public final /* synthetic */ int f4716j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public final /* synthetic */ ArrayList f4717k;
    public final /* synthetic */ h8.q3 l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ ec(ArrayList arrayList, h8.q3 q3Var, int i2) {
        super(4);
        this.f4716j = i2;
        this.f4717k = arrayList;
        this.l = q3Var;
    }
            ...
            case 0:
                ...
                if ((i2 & 147) == 146) {
                    ...
                    if (qVar3.D()) {
                        ...
                        dVar = (r7.d) this.f4717k.get(iIntValue);
                        qVar = (v0.q) mVar;
                        qVar.V(1043390159);
                        qVar.V(1142037488);
                        q3Var = this.l;
                        zH = qVar.h(q3Var) | qVar.f(dVar);
                        objM = qVar.M();
                        if (zH || objM == v0.l.f15818a) {
                            objM = new cc(q3Var, dVar, 1);
                            qVar.f0(objM);
                        }
                        qVar.p(false);
            ...
            default:
                ...
                if ((i10 & 147) == 146) {
                    ...
                    if (qVar4.D()) {
                        ...
                        dVar2 = (r7.d) this.f4717k.get(iIntValue3);
                        qVar2 = (v0.q) mVar2;
                        qVar2.V(-1010526576);
                        qVar2.V(-1556614971);
                        q3Var2 = this.l;
                        zH2 = qVar2.h(q3Var2) | qVar2.f(dVar2);
                        objM2 = qVar2.M();
                        if (zH2 || objM2 == v0.l.f15818a) {
                            objM2 = new cc(q3Var2, dVar2, 2);
                            qVar2.f0(objM2);
                        }
                        qVar2.p(false);
