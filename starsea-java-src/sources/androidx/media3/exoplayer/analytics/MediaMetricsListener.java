...
public final class MediaMetricsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    public static final class ErrorInfo {
        ...
        public ErrorInfo(int i2, int i10) {
            this.errorCode = i2;
    ...
    public static MediaMetricsListener create(Context context) {
        MediaMetricsManager mediaMetricsManagerB = z.b(context.getSystemService("media_metrics"));
    ...
    private static DrmInitData getDrmInitData(o0 o0Var) {
        DrmInitData drmInitData;
        m0 m0VarListIterator = o0Var.listIterator(0);
        while (m0VarListIterator.hasNext()) {
            Tracks.Group group = (Tracks.Group) m0VarListIterator.next();
    ...
    private static ErrorInfo getErrorInfo(PlaybackException playbackException, Context context, boolean z9) {
        int i2;
        boolean z10;
        ...
        if ((th instanceof HttpDataSource.InvalidContentTypeException) || (th instanceof ParserException)) {
            return new ErrorInfo(z9 ? 10 : 11, 0);
        }
        ...
        if (i10 >= 23 && (th2 instanceof MediaDrmResetException)) {
    ...
    private void maybeReportNetworkChange(long j10) {
        ...
        if (networkType != this.currentNetworkType) {
            ...
            this.playbackSession.reportNetworkEvent(z.c().setNetworkType(networkType).setTimeSinceCreatedMillis(j10 - this.startTimeMs).build());
        }
    }
    ...
    private void maybeReportPlaybackError(long j10) {
        ...
        this.playbackSession.reportPlaybackErrorEvent(z.d().setTimeSinceCreatedMillis(j10 - this.startTimeMs).setErrorCode(errorInfo.errorCode).setSubErrorCode(errorInfo.subErrorCode).setException(playbackException).build());
    ...
    private void maybeReportPlaybackStateChange(Player player, AnalyticsListener.Events events, long j10) {
        ...
        if (this.currentPlaybackState != iResolveNewPlaybackState) {
            ...
            this.reportedEventsForCurrentSession = true;
            this.playbackSession.reportPlaybackStateEvent(z.j().setState(this.currentPlaybackState).setTimeSinceCreatedMillis(j10 - this.startTimeMs).build());
        }
    }
    ...
    private void maybeUpdateAudioFormat(long j10, Format format, int i2) {
        ...
        reportTrackChangeEvent(0, j10, format, i2);
    }
    ...
    private void maybeUpdateMetricsBuilderValues(Player player, AnalyticsListener.Events events) {
        ...
        if (events.contains(2) && this.metricsBuilder != null && (drmInitData = getDrmInitData(player.getCurrentTracks().getGroups())) != null) {
            androidx.core.app.p.i(Util.castNonNull(this.metricsBuilder)).setDrmType(getDrmType(drmInitData));
        }
    ...
    private void maybeUpdateTextFormat(long j10, Format format, int i2) {
        ...
        reportTrackChangeEvent(2, j10, format, i2);
    }
    ...
    private void maybeUpdateVideoFormat(long j10, Format format, int i2) {
        ...
        reportTrackChangeEvent(1, j10, format, i2);
    }

    private void reportTrackChangeEvent(int i2, long j10, Format format, int i10) {
        TrackChangeEvent.Builder timeSinceCreatedMillis = z.n(i2).setTimeSinceCreatedMillis(j10 - this.startTimeMs);
        if (format != null) {
    ...
    public void onBandwidthEstimate(AnalyticsListener.EventTime eventTime, int i2, long j10, long j11) {
        ...
        if (mediaPeriodId != null) {
            ...
            this.bandwidthBytes.put(sessionForMediaPeriodId, Long.valueOf((l == null ? 0L : l.longValue()) + j10));
            this.bandwidthTimeMs.put(sessionForMediaPeriodId, Long.valueOf((l6 != null ? l6.longValue() : 0L) + ((long) i2)));
        }
    }
    ...
    public void onSessionActive(AnalyticsListener.EventTime eventTime, String str) {
        ...
        if (mediaPeriodId == null || !mediaPeriodId.isAd()) {
            ...
            this.metricsBuilder = z.g().setPlayerName(MediaLibraryInfo.TAG).setPlayerVersion(MediaLibraryInfo.VERSION);
            maybeUpdateTimelineMetadata(eventTime.timeline, eventTime.mediaPeriodId);
        }
    }
