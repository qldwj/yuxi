...
public final class MpegAudioUtil {
    ...
    public static final class Header {
        ...
        public boolean setForHeaderData(int i2) {
            ...
            int i12;
            int i13;
            if (!MpegAudioUtil.isMagicPresent(i2) || (i10 = (i2 >>> 19) & 3) == 1 || (i11 = (i2 >>> 17) & 3) == 0 || (i12 = (i2 >>> 12) & 15) == 0 || i12 == 15 || (i13 = (i2 >>> 10) & 3) == 3) {
                return false;
            }
            this.version = i10;
    ...
    public static int getFrameSize(int i2) {
        ...
        int i13;
        int i14;
        if (!isMagicPresent(i2) || (i10 = (i2 >>> 19) & 3) == 1 || (i11 = (i2 >>> 17) & 3) == 0 || (i12 = (i2 >>> 12) & 15) == 0 || i12 == 15 || (i13 = (i2 >>> 10) & 3) == 3) {
            return -1;
        }
    ...
    public static int getFrameSizeInSamples(int i2, int i10) {
        if (i10 == 1) {
            if (i2 == 3) {
                return 1152;
            }
    ...
    public static int parseMpegAudioFrameSampleCount(int i2) {
        int i10;
        int i11;
        if (!isMagicPresent(i2) || (i10 = (i2 >>> 19) & 3) == 1 || (i11 = (i2 >>> 17) & 3) == 0) {
            return -1;
        }
        int i12 = (i2 >>> 12) & 15;
        int i13 = (i2 >>> 10) & 3;
