...
public final class MetadataRetriever {
    ...
    public static final class MetadataRetrieverInternal {
        ...
        private final g7.d0 trackGroupsFuture;
            ...
            public final class MediaSourceCaller implements MediaSource.MediaSourceCaller {
                ...
                public final class MediaPeriodCallback implements MediaPeriod.Callback {
                    ...
                    public void onPrepared(MediaPeriod mediaPeriod) {
                        MetadataRetrieverInternal.this.trackGroupsFuture.l(mediaPeriod.getTrackGroups());
            ...
            public boolean handleMessage(Message message) {
                ...
                if (i2 == 2) {
                    try {
                        ...
                        MetadataRetrieverInternal.this.trackGroupsFuture.k(e10);
                        MetadataRetrieverInternal.this.mediaSourceHandler.obtainMessage(4).sendToTarget();
                        return true;
                    }
                }
        ...
        public MetadataRetrieverInternal(MediaSource.Factory factory, Clock clock) {
            ...
            this.trackGroupsFuture = new g7.d0();
        }

        public g7.x retrieveMetadata(MediaItem mediaItem) {
    ...
    public static g7.x retrieveMetadata(Context context, MediaItem mediaItem) {
        return retrieveMetadata(context, mediaItem, Clock.DEFAULT);
    }

    public static g7.x retrieveMetadata(MediaSource.Factory factory, MediaItem mediaItem) {
        return retrieveMetadata(factory, mediaItem, Clock.DEFAULT);
    }

    public static g7.x retrieveMetadata(Context context, MediaItem mediaItem, Clock clock) {
    ...
    private static g7.x retrieveMetadata(MediaSource.Factory factory, MediaItem mediaItem, Clock clock) {
