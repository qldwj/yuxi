...
public final class DownloadManager {
    ...
    public static final class DownloadUpdate {
        ...
        public DownloadUpdate(Download download, boolean z9, List<Download> list, Exception exc) {
    ...
    public static class Task extends Thread implements Downloader.ProgressListener {
        ...
        public void onProgress(long j10, long j11, float f5) {
        ...
        private Task(DownloadRequest downloadRequest, Downloader downloader, DownloadProgress downloadProgress, boolean z9, int i2, InternalHandler internalHandler) {
    ...
    public static Download mergeRequest(Download download, DownloadRequest downloadRequest, int i2, long j10) {
        int i10 = download.state;
        long j11 = (i10 == 5 || download.isTerminalState()) ? j10 : download.startTimeMs;
        int i11 = 7;
        if (i10 != 5 && i10 != 7) {
            i11 = i2 != 0 ? 1 : 0;
        }
        return new Download(download.request.copyWithMergedRequest(downloadRequest), i11, j11, j10, -1L, i2, 0);
    }
    ...
    private void onMessageProcessed(int i2, int i10) {
    ...
    private void setDownloadsPaused(boolean z9) {
        if (this.downloadsPaused == z9) {
            return;
        }
        this.downloadsPaused = z9;
        this.pendingMessages++;
        this.internalHandler.obtainMessage(2, z9 ? 1 : 0, 0).sendToTarget();
        boolean zUpdateWaitingForRequirements = updateWaitingForRequirements();
        Iterator<Listener> it = this.listeners.iterator();
        while (it.hasNext()) {
    ...
    public DownloadManager(Context context, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        Handler handlerCreateHandlerForCurrentOrMainLooper = Util.createHandlerForCurrentOrMainLooper(new g(1, this));
        ...
        this.internalHandler = internalHandler;
        h hVar = new h(this);
        this.requirementsListener = hVar;
    ...
    public static final class InternalHandler extends Handler {
        ...
        public InternalHandler(HandlerThread handlerThread, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory, Handler handler, int i2, int i10, boolean z9) {
        ...
        private static Download copyDownloadWithState(Download download, int i2, int i10) {
            return new Download(download.request, i2, download.startTimeMs, System.currentTimeMillis(), download.contentLength, i10, 0, download.progress);
        }

        private Download getDownload(String str, boolean z9) {
        ...
        private void onTaskStopped(Task task) {
            ...
            if (exc != null) {
                Log.e(DownloadManager.TAG, "Task failed: " + task.request + ", " + z9, exc);
            }
        ...
        private Download putDownload(Download download) {
            ...
            if (downloadIndex == -1) {
                ...
                Collections.sort(this.downloads, new i());
            } else {
                boolean z9 = download.startTimeMs != this.downloads.get(downloadIndex).startTimeMs;
        ...
        private Download putDownloadWithState(Download download, int i2, int i10) {
            Assertions.checkState((i2 == 3 || i2 == 4) ? false : true);
            return putDownload(copyDownloadWithState(download, i2, i10));
        }
        ...
        private void setStopReason(String str, int i2) {
            if (str == null) {
                for (int i10 = 0; i10 < this.downloads.size(); i10++) {
                    setStopReason(this.downloads.get(i10), i2);
                }
                try {
                ...
                if (download != null) {
                    ...
                    try {
                        ...
                        Log.e(DownloadManager.TAG, "Failed to set manual stop reason: ".concat(str), e11);
                    }
                }
            }
            syncTasks();
        ...
        private void setStopReason(Download download, int i2) {
            if (i2 == 0) {
                ...
                putDownload(new Download(download.request, i10, download.startTimeMs, System.currentTimeMillis(), download.contentLength, i2, 0, download.progress));
            }
        }
    }
}
