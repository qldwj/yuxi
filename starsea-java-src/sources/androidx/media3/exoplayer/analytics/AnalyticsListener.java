...
public interface AnalyticsListener {
    ...
    public static final class EventTime {
        ...
        public EventTime(long j10, Timeline timeline, int i2, MediaSource.MediaPeriodId mediaPeriodId, long j11, Timeline timeline2, int i10, MediaSource.MediaPeriodId mediaPeriodId2, long j12, long j13) {
            this.realtimeMs = j10;
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && EventTime.class == obj.getClass()) {
                ...
                if (this.realtimeMs == eventTime.realtimeMs && this.windowIndex == eventTime.windowIndex && this.eventPlaybackPositionMs == eventTime.eventPlaybackPositionMs && this.currentWindowIndex == eventTime.currentWindowIndex && this.currentPlaybackPositionMs == eventTime.currentPlaybackPositionMs && this.totalBufferedDurationMs == eventTime.totalBufferedDurationMs && android.support.v4.media.session.b.I(this.timeline, eventTime.timeline) && android.support.v4.media.session.b.I(this.mediaPeriodId, eventTime.mediaPeriodId) && android.support.v4.media.session.b.I(this.currentTimeline, eventTime.currentTimeline) && android.support.v4.media.session.b.I(this.currentMediaPeriodId, eventTime.currentMediaPeriodId)) {
                    return true;
                }
            }
            return false;
    ...
    @UnstableApi
    void onAudioUnderrun(EventTime eventTime, int i2, long j10, long j11);

    @UnstableApi
    void onAvailableCommandsChanged(EventTime eventTime, Player.Commands commands);

    @UnstableApi
    void onBandwidthEstimate(EventTime eventTime, int i2, long j10, long j11);
    ...
    @UnstableApi
    void onDeviceVolumeChanged(EventTime eventTime, int i2, boolean z9);
    ...
    @UnstableApi
    void onDroppedVideoFrames(EventTime eventTime, int i2, long j10);
    ...
    @UnstableApi
    void onPlayWhenReadyChanged(EventTime eventTime, boolean z9, int i2);
    ...
    @UnstableApi
    @Deprecated
    void onPlayerStateChanged(EventTime eventTime, boolean z9, int i2);
    ...
    @UnstableApi
    void onSurfaceSizeChanged(EventTime eventTime, int i2, int i10);
    ...
    @UnstableApi
    void onVideoFrameProcessingOffset(EventTime eventTime, long j10, int i2);
    ...
    @UnstableApi
    @Deprecated
    void onVideoSizeChanged(EventTime eventTime, int i2, int i10, int i11, float f5);
