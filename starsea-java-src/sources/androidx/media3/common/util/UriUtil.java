...
public final class UriUtil {
    ...
    public static String getRelativePath(Uri uri, Uri uri2) {
        ...
        if (scheme != null ? !(scheme2 == null || !y8.a.U(scheme, scheme2)) : scheme2 == null) {
            if (Util.areEqual(uri.getAuthority(), uri2.getAuthority())) {
                ...
                for (int i11 = i2; i11 < pathSegments.size(); i11++) {
                    sb.append("../");
                }
    ...
    private static String removeDotSegments(StringBuilder sb, int i2, int i10) {
        int i11;
        int iLastIndexOf;
        if (i2 >= i10) {
            return sb.toString();
        ...
        while (i12 <= i10) {
            ...
            if (i12 == i14 && sb.charAt(i13) == '.') {
                ...
                if (i12 == i13 + 2 && sb.charAt(i13) == '.' && sb.charAt(i14) == '.') {
                    ...
                    int i15 = iLastIndexOf > i2 ? iLastIndexOf : i2;
                    sb.delete(i15, i11);
                    i10 -= i11 - i15;
                } else {
                    iLastIndexOf = i12 + 1;
