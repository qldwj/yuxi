...
public final class DvbParser implements SubtitleParser {
    ...
    public static final class DisplayDefinition {
        ...
        public DisplayDefinition(int i2, int i10, int i11, int i12, int i13, int i14) {
            this.width = i2;
            this.height = i10;
    ...
    public static final class ObjectData {
        ...
        public ObjectData(int i2, boolean z9, byte[] bArr, byte[] bArr2) {
            this.id = i2;
            this.nonModifyingColorFlag = z9;
    ...
    public static final class PageComposition {
        ...
        public PageComposition(int i2, int i10, int i11, SparseArray<PageRegion> sparseArray) {
            this.timeOutSecs = i2;
            this.version = i10;
            this.state = i11;
    ...
    public static final class PageRegion {
        ...
        public PageRegion(int i2, int i10) {
    ...
    public static final class RegionComposition {
        ...
        public RegionComposition(int i2, boolean z9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, SparseArray<RegionObject> sparseArray) {
            this.id = i2;
            this.fillFlag = z9;
            this.width = i10;
            this.height = i11;
    ...
    public static final class RegionObject {
        ...
        public RegionObject(int i2, int i10, int i11, int i12, int i13, int i14) {
            this.type = i2;
            this.provider = i10;
    ...
    public static final class SubtitleService {
        ...
        public SubtitleService(int i2, int i10) {
    ...
    private static int[] generateDefault8BitClutEntries() {
        ...
        for (int i2 = 0; i2 < 256; i2++) {
            if (i2 < 8) {
                ...
                int i10 = i2 & TsExtractor.TS_STREAM_TYPE_DTS_HD;
                if (i10 == 0) {
    ...
    private static int paint2BitPixelCodeString(ParsableBitArray parsableBitArray, int[] iArr, byte[] bArr, int i2, int i10, Paint paint, Canvas canvas) {
        int i11;
        int bits;
        int bits2;
        boolean z9 = false;
        while (true) {
            ...
            if (i11 != 0 && paint != null) {
                ...
                canvas.drawRect(i2, i10, i2 + i11, 1 + i10, paint);
            }
            i2 += i11;
            if (z9) {
                return i2;
    ...
    private static int paint4BitPixelCodeString(ParsableBitArray parsableBitArray, int[] iArr, byte[] bArr, int i2, int i10, Paint paint, Canvas canvas) {
        int i11;
        int bits;
        int bits2;
        boolean z9 = false;
    ...
    private static int paint8BitPixelCodeString(ParsableBitArray parsableBitArray, int[] iArr, byte[] bArr, int i2, int i10, Paint paint, Canvas canvas) {
        boolean z9;
        int bits;
        boolean z10 = false;
        while (true) {
            ...
            if (bits != 0 && paint != null) {
                ...
                canvas.drawRect(i2, i10, i2 + bits, 1 + i10, paint);
            }
            i2 += bits;
            if (z9) {
                return i2;
    ...
    private static void paintPixelDataSubBlock(byte[] bArr, int[] iArr, int i2, int i10, int i11, Paint paint, Canvas canvas) {
        int[] iArr2;
        Paint paint2;
        Canvas canvas2;
        byte[] bArr2;
                ...
                switch (bits) {
                    case 16:
                        ...
                        if (i2 != 3) {
                            ...
                            iPaint2BitPixelCodeString = paint2BitPixelCodeString(parsableBitArray, iArr2, bArr2, iPaint2BitPixelCodeString, i12, paint2, canvas2);
                    ...
                    case 17:
                        ...
                        canvas2 = canvas;
                        paint2 = paint3;
                        iPaint2BitPixelCodeString = paint4BitPixelCodeString(parsableBitArray, iArr2, i2 == 3 ? bArrBuildClutMapTable == null ? defaultMap4To8 : bArrBuildClutMapTable : null, iPaint2BitPixelCodeString, i12, paint2, canvas2);
                        parsableBitArray.byteAlign();
                        break;
                    case 18:
                        iArr2 = iArr;
                        paint2 = paint;
                        canvas2 = canvas;
                        iPaint2BitPixelCodeString = paint8BitPixelCodeString(parsableBitArray, iArr2, null, iPaint2BitPixelCodeString, i12, paint2, canvas2);
                        break;
                    default:
                        switch (bits) {
                            case 32:
    ...
    private static void paintPixelDataSubBlocks(ObjectData objectData, ClutDefinition clutDefinition, int i2, int i10, int i11, Paint paint, Canvas canvas) {
        int[] iArr;
        if (i2 == 3) {
            iArr = clutDefinition.clutEntries8Bit;
        } else {
            iArr = i2 == 2 ? clutDefinition.clutEntries4Bit : clutDefinition.clutEntries2Bit;
        }
        int[] iArr2 = iArr;
        paintPixelDataSubBlock(objectData.topFieldData, iArr2, i2, i10, i11, paint, canvas);
        paintPixelDataSubBlock(objectData.bottomFieldData, iArr2, i2, i10, i11 + 1, paint, canvas);
    }
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray parsableBitArray, int i2) {
        ...
        while (i13 > 0) {
            ...
            double d3 = bits4 - 128;
            double d10 = bits - 128;
            iArr[bits6] = getColor((byte) (255 - (bits2 & 255)), Util.constrainValue((int) ((1.402d * d3) + d2), 0, 255), Util.constrainValue((int) ((d2 - (0.34414d * d10)) - (d3 * 0.71414d)), 0, 255), Util.constrainValue((int) ((d10 * 1.772d) + d2), 0, 255));
            i13 = i10;
            bits5 = bits5;
            i11 = 8;
            i12 = 2;
    ...
    private static DisplayDefinition parseDisplayDefinition(ParsableBitArray parsableBitArray) {
        ...
        return new DisplayDefinition(bits2, bits3, i2, i11, i10, bits);
    }
    ...
    private static RegionComposition parseRegionComposition(ParsableBitArray parsableBitArray, int i2) {
        ...
        SparseArray sparseArray = new SparseArray();
        while (i14 > 0) {
            int bits12 = parsableBitArray.readBits(i12);
            int bits13 = parsableBitArray.readBits(i13);
            int bits14 = parsableBitArray.readBits(i13);
    ...
    private CuesWithTiming parse(ParsableBitArray parsableBitArray) {
        ...
        if (pageComposition == null) {
            m0 m0Var = o0.f2565j;
            return new CuesWithTiming(o1.f2566m, C.TIME_UNSET, C.TIME_UNSET);
        }
        ...
        while (i10 < sparseArray.size()) {
            ...
            while (i13 < sparseArray2.size()) {
                ...
                if (objectData != null) {
                    paintPixelDataSubBlocks(objectData, clutDefinition2, regionComposition.depth, regionObjectValueAt.horizontalPosition + i11, regionObjectValueAt.verticalPosition + i12, objectData.nonModifyingColorFlag ? null : this.defaultPaint, this.canvas);
                }
                i13++;
                sparseArray = sparseArray;
            }
            SparseArray<PageRegion> sparseArray3 = sparseArray;
