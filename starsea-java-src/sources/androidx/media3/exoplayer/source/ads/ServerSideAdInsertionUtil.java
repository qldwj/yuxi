...
public final class ServerSideAdInsertionUtil {
    ...
    public static AdPlaybackState addAdGroupToAdPlaybackState(AdPlaybackState adPlaybackState, long j10, long j11, long... jArr) {
        ...
        AdPlaybackState adPlaybackStateWithContentResumeOffsetUs = adPlaybackState.withNewAdGroup(i2, mediaPeriodPositionUsForContent).withIsServerSideInserted(i2, true).withAdCount(i2, jArr.length).withAdDurationsUs(i2, jArr).withContentResumeOffsetUs(i2, j11);
        ...
        for (int i10 = 0; i10 < jArr.length && jArr[i10] == 0; i10++) {
            adPlaybackStateWithSkippedAd = adPlaybackStateWithSkippedAd.withSkippedAd(i2, i10);
        }
        return correctFollowingAdGroupTimes(adPlaybackStateWithSkippedAd, i2, Util.sum(jArr), j11);
    }

    private static AdPlaybackState correctFollowingAdGroupTimes(AdPlaybackState adPlaybackState, int i2, long j10, long j11) {
        long j12 = (-j10) + j11;
        while (true) {
            i2++;
            ...
            long j13 = adPlaybackState.getAdGroup(i2).timeUs;
            if (j13 != Long.MIN_VALUE) {
                adPlaybackState = adPlaybackState.withAdGroupTimeUs(i2, j13 + j12);
            }
        }
    }

    public static int getAdCountInGroup(AdPlaybackState adPlaybackState, int i2) {
        int i10 = adPlaybackState.getAdGroup(i2).count;
        if (i10 == -1) {
            return 0;
        }
        return i10;
    ...
    public static long getMediaPeriodPositionUsForAd(long j10, int i2, int i10, AdPlaybackState adPlaybackState) {
        int i11;
        ...
        if (i10 < getAdCountInGroup(adPlaybackState, i2)) {
            while (i11 < i10) {
    ...
    public static long getMediaPeriodPositionUsForContent(long j10, int i2, AdPlaybackState adPlaybackState) {
        if (i2 == -1) {
            i2 = adPlaybackState.adGroupCount;
        }
        long j11 = 0;
        for (int i10 = adPlaybackState.removedAdGroupCount; i10 < i2; i10++) {
    ...
    public static long getStreamPositionUsForAd(long j10, int i2, int i10, AdPlaybackState adPlaybackState) {
        int i11;
        AdPlaybackState.AdGroup adGroup = adPlaybackState.getAdGroup(i2);
        long j11 = j10 + adGroup.timeUs;
        int i12 = adPlaybackState.removedAdGroupCount;
    ...
    public static long getStreamPositionUsForContent(long j10, int i2, AdPlaybackState adPlaybackState) {
        if (i2 == -1) {
            i2 = adPlaybackState.adGroupCount;
        }
        long j11 = 0;
