...
public final class UdpDataSource extends BaseDataSource {
    ...
    public int read(byte[] bArr, int i2, int i10) throws UdpDataSourceException {
        if (i10 == 0) {
            return 0;
        }
        ...
        System.arraycopy(this.packetBuffer, length2 - i11, bArr, i2, iMin);
    ...
    public UdpDataSource(int i2, int i10) {
        super(true);
