...
public interface TrackOutput {
    ...
    public static final class CryptoData {
        ...
        public CryptoData(int i2, byte[] bArr, int i10, int i11) {
            this.cryptoMode = i2;
    ...
    int sampleData(DataReader dataReader, int i2, boolean z9) throws IOException;

    int sampleData(DataReader dataReader, int i2, boolean z9, int i10) throws IOException;

    void sampleData(ParsableByteArray parsableByteArray, int i2);

    void sampleData(ParsableByteArray parsableByteArray, int i2, int i10);

    void sampleMetadata(long j10, int i2, int i10, int i11, CryptoData cryptoData);
}
