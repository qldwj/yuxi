...
public final class SimpleCache implements Cache {
    ...
    private static long createUid(File file) throws IOException {
        ...
        File file2 = new File(file, a2.b.E(Long.toString(jAbs, 16), UID_FILE_SUFFIX));
    ...
    private void loadDirectory(File file, boolean z9, File[] fileArr, Map<String, CacheFileMetadata> map) {
        long j10;
        long j11;
        ...
        for (File file2 : fileArr) {
            ...
            } else if (!z9 || (!CachedContentIndex.isIndexFile(name) && !name.endsWith(UID_FILE_SUFFIX))) {
    ...
    private void removeSpanInternal(CacheSpan cacheSpan) {
        ...
        if (this.fileIndex != null) {
            ...
            try {
                ...
                a2.b.N("Failed to remove file index entry for: ", name, TAG);
            }
        }
    ...
    private SimpleCacheSpan touchSpan(String str, SimpleCacheSpan simpleCacheSpan) {
        ...
        SimpleCacheSpan lastTouchTimestamp = ((CachedContent) Assertions.checkNotNull(this.contentIndex.get(str))).setLastTouchTimestamp(simpleCacheSpan, jCurrentTimeMillis, z9);
    ...
    public SimpleCache(File file, CacheEvictor cacheEvictor, DatabaseProvider databaseProvider, byte[] bArr, boolean z9, boolean z10) {
        this(file, cacheEvictor, new CachedContentIndex(databaseProvider, file, bArr, z9, z10), (databaseProvider == null || z10) ? null : new CacheFileMetadataIndex(databaseProvider));
    }
