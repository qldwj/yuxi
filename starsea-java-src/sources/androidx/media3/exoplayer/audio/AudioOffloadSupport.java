...
public final class AudioOffloadSupport {
    ...
    public static final class Builder {
        ...
        public Builder setIsFormatSupported(boolean z9) {
            this.isFormatSupported = z9;
            return this;
        }

        public Builder setIsGaplessSupported(boolean z9) {
            this.isGaplessSupported = z9;
            return this;
        }

        public Builder setIsSpeedChangeSupported(boolean z9) {
            this.isSpeedChangeSupported = z9;
            return this;
        }
