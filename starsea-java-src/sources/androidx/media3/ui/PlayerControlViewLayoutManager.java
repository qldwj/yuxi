...
final class PlayerControlViewLayoutManager {
    ...
    public PlayerControlViewLayoutManager(final PlayerControlView playerControlView) {
        ...
        int i2 = 2;
        this.showAllBarsRunnable = new f(this, i2);
        int i10 = 3;
        ...
        valueAnimatorOfFloat3.addUpdateListener(new g(i2, this));
    ...
    private void animateOverflow(float f5) {
        ViewGroup viewGroup = this.extraControlsScrollView;
        if (viewGroup != null) {
            this.extraControlsScrollView.setTranslationX((int) ((1.0f - f5) * viewGroup.getWidth()));
        }
    ...
    private static ObjectAnimator ofTranslationY(float f5, float f10, View view) {
    ...
    public void onLayoutChange(View view, int i2, int i10, int i11, int i12, int i13, int i14, int i15, int i16) {
        ...
        boolean z9 = i11 - i2 != i15 - i13;
        if (this.isMinimalMode || !z9) {
            return;
        }
    ...
    private boolean useMinimalMode() {
        ...
        int i2 = widthWithMargins - paddingRight;
        ...
        return width <= Math.max(i2, getWidthWithMargins(this.timeView) + getWidthWithMargins(this.overflowShowButton)) || height <= (getHeightWithMargins(this.bottomBar) * 2) + (heightWithMargins - paddingBottom);
    }
    ...
    public void setShowButton(View view, boolean z9) {
        if (view == null) {
            return;
        }
        if (!z9) {
