...
public abstract class a {
    ...
    public static final void a(b bVar, e0 e0Var) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (g0Var instanceof i0) {
                g gVar = new g();
                i0 i0Var = (i0) g0Var;
                gVar.f15415d = i0Var.f15447j;
                gVar.f15424n = true;
                gVar.c();
                gVar.f15429s.d(i0Var.f15448k);
                gVar.c();
                gVar.c();
                gVar.f15413b = i0Var.l;
                gVar.c();
                gVar.f15414c = i0Var.f15449m;
                gVar.c();
                gVar.f15418g = i0Var.f15450n;
                gVar.c();
                gVar.f15416e = i0Var.f15451o;
                gVar.c();
                gVar.f15417f = i0Var.f15452p;
                gVar.f15425o = true;
                gVar.c();
                gVar.f15419h = i0Var.f15453q;
                gVar.f15425o = true;
                gVar.c();
                gVar.f15420i = i0Var.f15454r;
                gVar.f15425o = true;
                gVar.c();
                gVar.f15421j = i0Var.f15455s;
                gVar.f15425o = true;
                gVar.c();
                gVar.f15422k = i0Var.f15456t;
                gVar.f15426p = true;
                gVar.c();
                gVar.l = i0Var.f15457u;
                gVar.f15426p = true;
                gVar.c();
                gVar.f15423m = i0Var.f15458v;
                gVar.f15426p = true;
                gVar.c();
                bVar.e(i2, gVar);
                ...
                b bVar2 = new b();
                e0 e0Var2 = (e0) g0Var;
                bVar2.f15347k = e0Var2.f15401i;
                bVar2.c();
                bVar2.l = e0Var2.f15402j;
                bVar2.f15354s = true;
                bVar2.c();
                bVar2.f15350o = e0Var2.f15404m;
                bVar2.f15354s = true;
                bVar2.c();
                bVar2.f15351p = e0Var2.f15405n;
                bVar2.f15354s = true;
                bVar2.c();
                bVar2.f15352q = e0Var2.f15406o;
                bVar2.f15354s = true;
                bVar2.c();
                bVar2.f15353r = e0Var2.f15407p;
                bVar2.f15354s = true;
                bVar2.c();
                bVar2.f15348m = e0Var2.f15403k;
                bVar2.f15354s = true;
                bVar2.c();
                bVar2.f15349n = e0Var2.l;
                bVar2.f15354s = true;
                bVar2.c();
                bVar2.f15342f = e0Var2.f15408q;
                bVar2.f15343g = true;
                bVar2.c();
                a(bVar2, e0Var2);
                bVar.e(i2, bVar2);
    ...
    public static final void b(m0 m0Var, double d2, double d3, double d10, double d11, double d12, double d13, double d14, boolean z9, boolean z10) {
        double d15;
        double d16;
        double d17 = d12;
        double d18 = (d14 / ((double) 180)) * 3.141592653589793d;
        double dCos = Math.cos(d18);
        double dSin = Math.sin(d18);
        double d19 = ((d3 * dSin) + (d2 * dCos)) / d17;
        double d20 = ((d3 * dCos) + ((-d2) * dSin)) / d13;
        double d21 = ((d11 * dSin) + (d10 * dCos)) / d17;
        double d22 = ((d11 * dCos) + ((-d10) * dSin)) / d13;
        double d23 = d19 - d21;
        double d24 = d20 - d22;
        double d25 = 2;
        ...
        if (d29 < 0.0d) {
            ...
            b(m0Var, d2, d3, d10, d11, d17 * dSqrt, d13 * dSqrt, d14, z9, z10);
            return;
        }
        ...
        double dAtan2 = Math.atan2(d20 - d16, d19 - d15);
        double dAtan3 = Math.atan2(d22 - d16, d21 - d15) - dAtan2;
        if (z10 != (dAtan3 >= 0.0d)) {
        ...
        double d36 = 4;
        int iCeil = (int) Math.ceil(Math.abs((dAtan3 * d36) / 3.141592653589793d));
        ...
        double d37 = dAtan3;
        double d38 = -d17;
        double d39 = d38 * dCos2;
        double d40 = d13 * dSin2;
        double d41 = (d39 * dSin3) - (d40 * dCos3);
        double d42 = d38 * dSin2;
        double d43 = d13 * dCos2;
        double d44 = (dCos3 * d43) + (dSin3 * d42);
        double d45 = d37 / ((double) iCeil);
        double d46 = dAtan2;
        double d47 = d41;
        int i2 = 0;
        double d48 = d2;
        ...
        while (i2 < iCeil) {
            double d51 = d46 + d45;
            double dSin4 = Math.sin(d51);
            double dCos4 = Math.cos(d51);
            int i10 = i2;
            double d52 = (((d17 * dCos2) * dCos4) + d34) - (d40 * dSin4);
            int i11 = iCeil;
            double d53 = (d43 * dSin4) + (d17 * dSin2 * dCos4) + d35;
            double d54 = (d39 * dSin4) - (d40 * dCos4);
            double d55 = (dCos4 * d43) + (dSin4 * d42);
            double d56 = d51 - d46;
            double dTan = Math.tan(d56 / d25);
            double dSqrt3 = ((Math.sqrt(((3.0d * dTan) * dTan) + d36) - ((double) 1)) * Math.sin(d56)) / ((double) 3);
            ((o1.l) m0Var).f11016a.cubicTo((float) ((d47 * dSqrt3) + d48), (float) ((d49 * dSqrt3) + d50), (float) (d52 - (dSqrt3 * d54)), (float) (d53 - (dSqrt3 * d55)), (float) d52, (float) d53);
            dSin2 = dSin2;
            d48 = d52;
            i2 = i10 + 1;
            d34 = d34;
    ...
    public static final h0 c(e eVar, v0.m mVar) {
        o1.o oVar;
        v0.q qVar = (v0.q) mVar;
        b3.b bVar = (b3.b) qVar.k(l1.f7394f);
        boolean zE = qVar.e((((long) Float.floatToRawIntBits(bVar.b())) & 4294967295L) | (((long) Float.floatToRawIntBits(eVar.f15400j)) << 32));
        Object objM = qVar.M();
        if (zE || objM == v0.l.f15818a) {
            b bVar2 = new b();
            a(bVar2, eVar.f15396f);
            long jN = da.a.n(bVar.N(eVar.f15392b), bVar.N(eVar.f15393c));
            float fD = eVar.f15394d;
            float fB = eVar.f15395e;
            if (Float.isNaN(fD)) {
                fD = n1.f.d(jN);
            }
            if (Float.isNaN(fB)) {
            ...
            long jN2 = da.a.n(fD, fB);
            h0 h0Var = new h0(bVar2);
            String str = eVar.f15391a;
            long j10 = eVar.f15397g;
            int i2 = eVar.f15398h;
            if (j10 != 16) {
                oVar = new o1.o(j10, i2, Build.VERSION.SDK_INT >= 29 ? o1.p.f11028a.a(j10, i2) : new PorterDuffColorFilter(o0.y(j10), o0.B(i2)));
            } else {
                oVar = null;
            }
            boolean z9 = eVar.f15399i;
            h0Var.f15438n.setValue(new n1.f(jN));
            h0Var.f15439o.setValue(Boolean.valueOf(z9));
            d0 d0Var = h0Var.f15440p;
            d0Var.f15384g.setValue(oVar);
            d0Var.f15386i.setValue(new n1.f(jN2));
            d0Var.f15380c = str;
            qVar.f0(h0Var);
            objM = h0Var;
        }
    ...
    public static final void d(List list, m0 m0Var) {
        a0 a0Var;
        a0 a0Var2;
        float f5;
        float f10;
        ...
        Path path2 = lVar.f11016a;
        int i2 = path.getFillType() == Path.FillType.EVEN_ODD ? 1 : 0;
        path2.rewind();
        lVar.d(i2);
        a0 a0Var3 = list2.isEmpty() ? i.f15445c : (a0) list2.get(0);
        int size = list2.size();
        float f17 = 0.0f;
        int i10 = 0;
        float f18 = 0.0f;
        ...
        float f23 = 0.0f;
        while (i10 < size) {
            a0 a0Var4 = (a0) list2.get(i10);
            if (a0Var4 instanceof i) {
                path2.close();
                path2 = path2;
                size = size;
                f17 = f17;
                ...
                if (a0Var4 instanceof u) {
                    u uVar = (u) a0Var4;
                    float f24 = uVar.f15496c;
                    f20 += f24;
                    float f25 = uVar.f15497d;
                    f21 += f25;
                    path2.rMoveTo(f24, f25);
                    path2 = path2;
                    f22 = f20;
                    f23 = f21;
                } else if (a0Var4 instanceof m) {
                    m mVar = (m) a0Var4;
                    float f26 = mVar.f15468c;
                    float f27 = mVar.f15469d;
                    path2.moveTo(f26, f27);
                    f21 = f27;
                    f23 = f21;
                    f20 = f26;
                    f22 = f20;
                } else if (a0Var4 instanceof t) {
                    t tVar = (t) a0Var4;
                    float f28 = tVar.f15495d;
                    float f29 = tVar.f15494c;
                    path2.rLineTo(f29, f28);
                    f20 += f29;
                    f21 += f28;
                } else if (a0Var4 instanceof l) {
                    l lVar2 = (l) a0Var4;
                    float f30 = lVar2.f15467d;
                    float f31 = lVar2.f15466c;
                    lVar.a(f31, f30);
                    f20 = f31;
                    f21 = f30;
                } else if (a0Var4 instanceof s) {
                    float f32 = ((s) a0Var4).f15493c;
                    path2.rLineTo(f32, f17);
                    f20 += f32;
                } else if (a0Var4 instanceof k) {
                    float f33 = ((k) a0Var4).f15465c;
                    lVar.a(f33, f21);
                    f20 = f33;
                } else {
                    if (a0Var4 instanceof y) {
                        f16 = ((y) a0Var4).f15508c;
                        path2.rLineTo(f17, f16);
                    } else if (a0Var4 instanceof z) {
                        float f34 = ((z) a0Var4).f15509c;
                        lVar.a(f20, f34);
                        f21 = f34;
                    } else if (a0Var4 instanceof r) {
                        r rVar = (r) a0Var4;
                        path2.rCubicTo(rVar.f15487c, rVar.f15488d, rVar.f15489e, rVar.f15490f, rVar.f15491g, rVar.f15492h);
                        f18 = rVar.f15489e + f20;
                        f19 = rVar.f15490f + f21;
                        f20 += rVar.f15491g;
                        f16 = rVar.f15492h;
                    } else {
                        if (a0Var4 instanceof j) {
                            j jVar = (j) a0Var4;
                            path2.cubicTo(jVar.f15459c, jVar.f15460d, jVar.f15461e, jVar.f15462f, jVar.f15463g, jVar.f15464h);
                            f18 = jVar.f15461e;
                            f19 = jVar.f15462f;
                            f12 = jVar.f15463g;
                            f13 = jVar.f15464h;
                        } else if (a0Var4 instanceof w) {
                            if (a0Var3.f15336a) {
                                f15 = f21 - f19;
                                f14 = f20 - f18;
                            } else {
                            ...
                            w wVar = (w) a0Var4;
                            path2.rCubicTo(f14, f15, wVar.f15502c, wVar.f15503d, wVar.f15504e, wVar.f15505f);
                            f18 = wVar.f15502c + f20;
                            f19 = wVar.f15503d + f21;
                            f20 += wVar.f15504e;
                            f16 = wVar.f15505f;
                        } else if (a0Var4 instanceof o) {
                            if (a0Var3.f15336a) {
                                float f35 = 2;
                                f20 = (f20 * f35) - f18;
                                f21 = (f35 * f21) - f19;
                            ...
                            o oVar = (o) a0Var4;
                            path2.cubicTo(f20, f21, oVar.f15474c, oVar.f15475d, oVar.f15476e, oVar.f15477f);
                            f18 = oVar.f15474c;
                            f19 = oVar.f15475d;
                            f12 = oVar.f15476e;
                            f13 = oVar.f15477f;
                        } else if (a0Var4 instanceof v) {
                            v vVar = (v) a0Var4;
                            float f36 = vVar.f15501f;
                            float f37 = vVar.f15500e;
                            float f38 = vVar.f15499d;
                            float f39 = vVar.f15498c;
                            path2.rQuadTo(f39, f38, f37, f36);
                            float f40 = f39 + f20;
                            float f41 = f38 + f21;
                            f20 += f37;
                            f21 += f36;
                            ...
                            if (a0Var4 instanceof n) {
                                n nVar = (n) a0Var4;
                                float f42 = nVar.f15473f;
                                float f43 = nVar.f15472e;
                                float f44 = nVar.f15471d;
                                f11 = nVar.f15470c;
                                path2.quadTo(f11, f44, f43, f42);
                                f21 = f42;
                                f20 = f43;
                                f19 = f44;
                            } else if (a0Var4 instanceof x) {
                                if (a0Var3.f15337b) {
                                    f5 = f20 - f18;
                                    f10 = f21 - f19;
                                } else {
                                ...
                                x xVar = (x) a0Var4;
                                float f45 = xVar.f15507d;
                                float f46 = xVar.f15506c;
                                path2.rQuadTo(f5, f10, f46, f45);
                                f11 = f5 + f20;
                                float f47 = f10 + f21;
                                f20 += f46;
                                f21 += f45;
                                f19 = f47;
                            } else if (a0Var4 instanceof p) {
                                if (a0Var3.f15337b) {
                                    float f48 = 2;
                                    f20 = (f20 * f48) - f18;
                                    f21 = (f48 * f21) - f19;
                                ...
                                p pVar = (p) a0Var4;
                                float f49 = pVar.f15479d;
                                float f50 = pVar.f15478c;
                                path2.quadTo(f20, f21, f50, f49);
                                path2 = path2;
                                size = size;
                                f17 = f17;
                                i10 = i10;
                                ...
                                if (a0Var4 instanceof q) {
                                    q qVar = (q) a0Var4;
                                    float f51 = qVar.f15485h + f20;
                                    float f52 = qVar.f15486i + f21;
                                    path2 = path2;
                                    i10 = i10;
                                    f17 = 0.0f;
                                    size = size;
                                    a0Var = a0Var4;
                                    lVar = lVar;
                                    b(lVar, f20, f21, f51, f52, qVar.f15480c, qVar.f15481d, qVar.f15482e, qVar.f15483f, qVar.f15484g);
                                    f18 = f51;
                                    f20 = f18;
                                    f19 = f52;
                                    f21 = f19;
                                    ...
                                    if (a0Var instanceof h) {
                                        h hVar = (h) a0Var;
                                        float f53 = hVar.f15437i;
                                        float f54 = hVar.f15436h;
                                        a0Var2 = a0Var;
                                        lVar = lVar;
                                        b(lVar, f20, f21, f54, f53, hVar.f15431c, hVar.f15432d, hVar.f15433e, hVar.f15434f, hVar.f15435g);
                                        f19 = f53;
                                        f21 = f19;
                                        f18 = f54;
                                        f20 = f18;
