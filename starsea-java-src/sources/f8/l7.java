...
public final class l7 extends w8.l implements v8.g {

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public final /* synthetic */ int f5190j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public final /* synthetic */ ArrayList f5191k;
    public final /* synthetic */ h8.j1 l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ l7(ArrayList arrayList, h8.j1 j1Var, int i2) {
        super(4);
        this.f5190j = i2;
        this.f5191k = arrayList;
        this.l = j1Var;
    }
            ...
            case 0:
                ...
                if ((i2 & 147) == 146) {
                    ...
                    if (qVar3.D()) {
                        ...
                        dVar = (r7.d) this.f5191k.get(iIntValue);
                        qVar = (v0.q) mVar;
                        qVar.V(636319653);
                        qVar.V(1821642842);
                        j1Var = this.l;
                        zH = qVar.h(j1Var) | qVar.f(dVar);
                        objM = qVar.M();
                        if (zH || objM == v0.l.f15818a) {
                            objM = new j7(j1Var, dVar, 1);
                            qVar.f0(objM);
                        }
                        qVar.p(false);
            ...
            default:
                ...
                if ((i10 & 147) == 146) {
                    ...
                    if (qVar4.D()) {
                        ...
                        dVar2 = (r7.d) this.f5191k.get(iIntValue3);
                        qVar2 = (v0.q) mVar2;
                        qVar2.V(-1417384422);
                        qVar2.V(-877002513);
                        j1Var2 = this.l;
                        zH2 = qVar2.h(j1Var2) | qVar2.f(dVar2);
                        objM2 = qVar2.M();
                        if (zH2 || objM2 == v0.l.f15818a) {
                            objM2 = new j7(j1Var2, dVar2, 2);
                            qVar2.f0(objM2);
                        }
                        qVar2.p(false);
