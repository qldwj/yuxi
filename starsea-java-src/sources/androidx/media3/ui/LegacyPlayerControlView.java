...
public class LegacyPlayerControlView extends FrameLayout {
    ...
    public final class ComponentListener implements Player.Listener, TimeBar.OnScrubListener, View.OnClickListener {
        ...
        public void onScrubStop(TimeBar timeBar, long j10, boolean z9) {
            ...
            if (z9 || LegacyPlayerControlView.this.player == null) {
                return;
            }
    ...
    private void seekTo(Player player, int i2, long j10) {
    ...
    private void updateButton(boolean z9, boolean z10, View view) {
        if (view == null) {
            return;
        }
        view.setEnabled(z10);
    ...
    public void updatePlayPauseButton() {
        ...
        if (isVisible() && this.isAttachedToWindow) {
            ...
            boolean z11 = true;
            if (view != null) {
                z9 = !zShouldShowPlayButton && view.isFocused();
                if (Util.SDK_INT < 21) {
                    z10 = z9;
                } else {
                    z10 = !zShouldShowPlayButton && Api21.isAccessibilityFocused(this.playButton);
                }
            ...
            if (view2 != null) {
                z9 |= zShouldShowPlayButton && view2.isFocused();
                if (Util.SDK_INT < 21) {
                    z11 = z9;
    ...
    public void updateProgress() {
        ...
        if (isVisible() && this.isAttachedToWindow) {
            ...
            boolean z9 = contentPosition != this.currentPosition;
            ...
            if (textView != null && !this.scrubbing && z9) {
    ...
    public void updateTimeline() {
        ...
        if (currentTimeline.isEmpty()) {
            ...
            while (i10 <= windowCount) {
                ...
                if (j13 == C.TIME_UNSET) {
                    Assertions.checkState(this.multiWindowTimeBar ^ z9);
                    break;
                }
                    ...
                    if (i11 <= window.lastPeriodIndex) {
                        ...
                        while (removedAdGroupCount < adGroupCount) {
                            ...
                            if (positionInWindowUs >= j10) {
                                ...
                                this.adGroupTimesMs[i2] = Util.usToMs(positionInWindowUs + j12);
    ...
    public void setShowRewindButton(boolean z9) {
        this.showRewindButton = z9;
        updateNavigation();
    }

    public void setShowShuffleButton(boolean z9) {
        this.showShuffleButton = z9;
        updateShuffleButton();
    }
    ...
    public LegacyPlayerControlView(Context context, AttributeSet attributeSet, int i2, AttributeSet attributeSet2) {
        ...
        this.updateProgressAction = new Runnable(this) { // from class: androidx.media3.ui.b
            ...
            public final /* synthetic */ LegacyPlayerControlView f1411j;
