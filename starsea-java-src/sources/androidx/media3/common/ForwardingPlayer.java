...
public class ForwardingPlayer implements Player {
    ...
    public static final class ForwardingListener implements Player.Listener {
        ...
        public void onDeviceVolumeChanged(int i2, boolean z9) {
            this.listener.onDeviceVolumeChanged(i2, z9);
        }
        ...
        public void onPlayWhenReadyChanged(boolean z9, int i2) {
            this.listener.onPlayWhenReadyChanged(z9, i2);
        }
        ...
        public void onPlayerStateChanged(boolean z9, int i2) {
            this.listener.onPlayerStateChanged(z9, i2);
        }
        ...
        public void onSurfaceSizeChanged(int i2, int i10) {
            this.listener.onSurfaceSizeChanged(i2, i10);
        }
    ...
    public void moveMediaItem(int i2, int i10) {
        this.player.moveMediaItem(i2, i10);
    }
    ...
    public void setMediaItem(MediaItem mediaItem, boolean z9) {
        this.player.setMediaItem(mediaItem, z9);
    }
