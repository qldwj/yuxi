...
public final class Format {
    ...
    public static Format fromBundle(Bundle bundle) {
        ...
        if (parcelableArrayList == null) {
            ...
            listFromBundleList = BundleCollectionUtil.fromBundleList(new b(1), parcelableArrayList);
        }
        builder.setLabels(listFromBundleList).setLanguage((String) defaultIfNull(bundle.getString(FIELD_LANGUAGE), format.language)).setSelectionFlags(bundle.getInt(FIELD_SELECTION_FLAGS, format.selectionFlags)).setRoleFlags(bundle.getInt(FIELD_ROLE_FLAGS, format.roleFlags)).setAverageBitrate(bundle.getInt(FIELD_AVERAGE_BITRATE, format.averageBitrate)).setPeakBitrate(bundle.getInt(FIELD_PEAK_BITRATE, format.peakBitrate)).setCodecs((String) defaultIfNull(bundle.getString(FIELD_CODECS), format.codecs)).setMetadata((Metadata) defaultIfNull((Metadata) bundle.getParcelable(FIELD_METADATA), format.metadata)).setContainerMimeType((String) defaultIfNull(bundle.getString(FIELD_CONTAINER_MIME_TYPE), format.containerMimeType)).setSampleMimeType((String) defaultIfNull(bundle.getString(FIELD_SAMPLE_MIME_TYPE), format.sampleMimeType)).setMaxInputSize(bundle.getInt(FIELD_MAX_INPUT_SIZE, format.maxInputSize));
    ...
    public static String toLogString(Format format) {
        ...
        if (format.drmInitData != null) {
            ...
            sb.append(", drm=[");
            new b7.f(String.valueOf(',')).a(sb, linkedHashSet.iterator());
            sb.append(']');
        }
        ...
        if (!format.labels.isEmpty()) {
            sb.append(", labels=[");
            new b7.f(String.valueOf(',')).a(sb, format.labels.iterator());
            sb.append("]");
        }
        if (format.selectionFlags != 0) {
            sb.append(", selectionFlags=[");
            new b7.f(String.valueOf(',')).a(sb, Util.getSelectionFlagStrings(format.selectionFlags).iterator());
            sb.append("]");
        }
        if (format.roleFlags != 0) {
            sb.append(", roleFlags=[");
            new b7.f(String.valueOf(',')).a(sb, Util.getRoleFlagStrings(format.roleFlags).iterator());
            sb.append("]");
        }
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            ...
            this.hashCode = ((((((((((((((((((j0.q(this.pixelWidthHeightRatio, (j0.q(this.frameRate, (((((((((iHashCode7 + (str6 != null ? str6.hashCode() : 0)) * 31) + this.maxInputSize) * 31) + ((int) this.subsampleOffsetUs)) * 31) + this.width) * 31) + this.height) * 31, 31) + this.rotationDegrees) * 31, 31) + this.stereoMode) * 31) + this.channelCount) * 31) + this.sampleRate) * 31) + this.pcmEncoding) * 31) + this.encoderDelay) * 31) + this.encoderPadding) * 31) + this.accessibilityChannel) * 31) + this.tileCountHorizontal) * 31) + this.tileCountVertical) * 31) + this.cryptoType;
        }
    ...
    private Format(Builder builder) {
        ...
        if (builder.labels.isEmpty() && builder.label != null) {
            this.labels = o0.n(new Label(strNormalizeLanguageCode, builder.label));
    ...
    public Bundle toBundle(boolean z9) {
        ...
        bundle.putParcelableArrayList(FIELD_LABELS, BundleCollectionUtil.toBundleArrayList(this.labels, new b(2)));
