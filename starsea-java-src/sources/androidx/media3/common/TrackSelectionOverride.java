...
public final class TrackSelectionOverride {
    ...
    public final o0 trackIndices;
    private static final String FIELD_TRACK_GROUP = Util.intToStringMaxRadix(0);
    private static final String FIELD_TRACKS = Util.intToStringMaxRadix(1);

    public TrackSelectionOverride(TrackGroup trackGroup, int i2) {
        this(trackGroup, o0.n(Integer.valueOf(i2)));
    }

    @UnstableApi
    public static TrackSelectionOverride fromBundle(Bundle bundle) {
        return new TrackSelectionOverride(TrackGroup.fromBundle((Bundle) Assertions.checkNotNull(bundle.getBundle(FIELD_TRACK_GROUP))), (List<Integer>) y8.a.D((int[]) Assertions.checkNotNull(bundle.getIntArray(FIELD_TRACKS))));
    }
    ...
    public Bundle toBundle() {
        ...
        bundle.putIntArray(FIELD_TRACKS, y8.a.m0(this.trackIndices));
        return bundle;
    }
