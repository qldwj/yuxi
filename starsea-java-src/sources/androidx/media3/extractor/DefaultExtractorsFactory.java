...
public final class DefaultExtractorsFactory implements ExtractorsFactory {
    ...
    private static final ExtensionLoader FLAC_EXTENSION_LOADER = new ExtensionLoader(new androidx.media3.common.b(21));
    private static final ExtensionLoader MIDI_EXTENSION_LOADER = new ExtensionLoader(new androidx.media3.common.b(22));
        ...
        switch (i2) {
            ...
            case 11:
                if (this.tsSubtitleFormats == null) {
                    m0 m0Var = o0.f2565j;
                    this.tsSubtitleFormats = o1.f2566m;
                }
    ...
    public synchronized DefaultExtractorsFactory setConstantBitrateSeekingAlwaysEnabled(boolean z9) {
        this.constantBitrateSeekingAlwaysEnabled = z9;
        return this;
    }

    public synchronized DefaultExtractorsFactory setConstantBitrateSeekingEnabled(boolean z9) {
        this.constantBitrateSeekingEnabled = z9;
        return this;
    }
    ...
    @Deprecated
    public synchronized DefaultExtractorsFactory setTextTrackTranscodingEnabled(boolean z9) {
    ...
    public synchronized DefaultExtractorsFactory setTsSubtitleFormats(List<Format> list) {
        this.tsSubtitleFormats = o0.j(list);
        return this;
    }
    ...
    public synchronized Extractor[] createExtractors(Uri uri, Map<String, List<String>> map) {
        ...
        try {
            ...
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                Extractor subtitleTranscodingExtractor = (Extractor) arrayList.get(i10);
                ...
                extractorArr[i10] = subtitleTranscodingExtractor;
            }
        } catch (Throwable th) {
            throw th;
        }
    ...
    @Override // androidx.media3.extractor.ExtractorsFactory
    @Deprecated
    public synchronized DefaultExtractorsFactory experimentalSetTextTrackTranscodingEnabled(boolean z9) {
        this.textTrackTranscodingEnabled = z9;
        return this;
    }

    @Override // androidx.media3.extractor.ExtractorsFactory
    /* JADX INFO: renamed from: setSubtitleParserFactory */
    public synchronized DefaultExtractorsFactory mo0setSubtitleParserFactory(SubtitleParser.Factory factory) {
