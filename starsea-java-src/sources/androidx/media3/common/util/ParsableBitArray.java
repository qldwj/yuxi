...
public final class ParsableBitArray {
    ...
    public void putInt(int i2, int i10) {
        ...
        bArr[i13] = b10;
        int i14 = i10 - iMin;
        bArr[i13] = (byte) (b10 | ((i2 >>> i14) << i12));
        int i15 = i13 + 1;
        while (i14 > 8) {
            this.data[i15] = (byte) (i2 >>> (i14 - 8));
            i14 -= 8;
            i15++;
        }
        int i16 = 8 - i14;
        ...
        bArr2[i15] = b11;
        bArr2[i15] = (byte) (((i2 & ((1 << i14) - 1)) << i16) | b11);
        skipBits(i10);
        assertValidOffset();
    }
    ...
    public void readBytes(byte[] bArr, int i2, int i10) {
        Assertions.checkState(this.bitOffset == 0);
        System.arraycopy(this.data, this.byteOffset, bArr, i2, i10);
        this.byteOffset += i10;
        assertValidOffset();
    }

    public String readBytesAsString(int i2) {
        return readBytesAsString(i2, b7.d.f2150c);
    }
