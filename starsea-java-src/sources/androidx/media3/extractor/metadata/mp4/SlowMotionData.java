...
public final class SlowMotionData implements Metadata.Entry {
    ...
    public static final class Segment implements Parcelable {
        ...
        public Segment(long j10, long j11, int i2) {
        ...
        public static /* synthetic */ int lambda$static$0(Segment segment, Segment segment2) {
            return d0.f2521a.b(segment.startTimeMs, segment2.startTimeMs).b(segment.endTimeMs, segment2.endTimeMs).a(segment.speedDivisor, segment2.speedDivisor).f();
        }
    ...
    private static boolean doSegmentsOverlap(List<Segment> list) {
        ...
        for (int i2 = 1; i2 < list.size(); i2++) {
            if (list.get(i2).startTimeMs < j10) {
                return true;
            }
            j10 = list.get(i2).endTimeMs;
        }
        return false;
    }
