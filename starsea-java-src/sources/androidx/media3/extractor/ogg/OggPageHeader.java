...
final class OggPageHeader {
    ...
    public boolean populate(ExtractorInput extractorInput, boolean z9) throws IOException {
        reset();
        this.scratch.reset(27);
        if (!ExtractorUtil.peekFullyQuietly(extractorInput, this.scratch.getData(), 0, 27, z9) || this.scratch.readUnsignedInt() != 1332176723) {
            return false;
        }
        ...
        if (!ExtractorUtil.peekFullyQuietly(extractorInput, this.scratch.getData(), 0, this.pageSegmentCount, z9)) {
            return false;
        }
