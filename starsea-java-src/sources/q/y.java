...
public final class y extends MultiAutoCompleteTextView implements f4.r {
    public static final int[] l = {R.attr.popupBackground};

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public final androidx.recyclerview.widget.b f12555i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public final z0 f12556j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public final a0 f12557k;
    ...
    public final void drawableStateChanged() {
        ...
        androidx.recyclerview.widget.b bVar = this.f12555i;
        if (bVar != null) {
            bVar.a();
        }
        z0 z0Var = this.f12556j;
        if (z0Var != null) {
            z0Var.b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f12556j.d();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f12556j.e();
    }
    ...
    public final InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f12557k.c(inputConnectionOnCreateInputConnection, editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f12557k.a(keyListener));
    }
