...
public final class DtsReader implements ElementaryStreamReader {
    ...
    public DtsReader(String str, int i2, int i10) {
    ...
    private void parseCoreHeader() {
        ...
        this.sampleDurationUs = a.F(Util.sampleCountToDurationUs(DtsUtil.parseDtsAudioSampleCount(data), this.format.sampleRate));
    }
    ...
    private void updateFormatWithDtsHeaderInfo(DtsUtil.DtsHeader dtsHeader) {
        ...
        if (i10 == -2147483647 || (i2 = dtsHeader.channelCount) == -1) {
            return;
        }
        Format format = this.format;
        if (format != null && i2 == format.channelCount && i10 == format.sampleRate && Util.areEqual(dtsHeader.mimeType, format.sampleMimeType)) {
            return;
        }
