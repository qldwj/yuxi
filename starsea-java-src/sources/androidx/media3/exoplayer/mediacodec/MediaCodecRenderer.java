...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    public MediaCodecRenderer(int i2, MediaCodecAdapter.Factory factory, MediaCodecSelector mediaCodecSelector, boolean z9, float f5) {
        super(i2);
    ...
    private boolean bypassRender(long j10, long j11) throws ExoPlaybackException {
        ...
        if (this.bypassSampleBufferPending) {
            ...
            this.bypassSampleBufferPending = z9;
        }
        if (this.bypassDrainAndReinitialize) {
            ...
            disableBypass();
            this.bypassDrainAndReinitialize = z9;
    ...
    private boolean drainOutputBuffer(long j10, long j11) throws ExoPlaybackException {
        ...
        if (this.codecNeedsEosOutputExceptionWorkaround && this.codecReceivedEos) {
            try {
                ...
                z9 = false;
                try {
                    zProcessOutputBuffer = processOutputBuffer(j10, j11, mediaCodecAdapter, byteBuffer2, i2, bufferInfo4.flags, 1, bufferInfo4.presentationTimeUs, this.isDecodeOnlyOutputBuffer, this.isLastOutputBuffer, (Format) Assertions.checkNotNull(this.outputFormat));
            ...
            zProcessOutputBuffer = processOutputBuffer(j10, j11, mediaCodecAdapter, byteBuffer3, i10, bufferInfo5.flags, 1, bufferInfo5.presentationTimeUs, this.isDecodeOnlyOutputBuffer, this.isLastOutputBuffer, (Format) Assertions.checkNotNull(this.outputFormat));
        }
        if (zProcessOutputBuffer) {
            onProcessedOutputBuffer(this.outputBufferInfo.presentationTimeUs);
            boolean z10 = (this.outputBufferInfo.flags & 4) != 0 ? true : z9;
            resetOutputBuffer();
            if (!z10) {
                return true;
            }
    ...
    private List<MediaCodecInfo> getAvailableCodecInfos(boolean z9) throws MediaCodecUtil.DecoderQueryException {
        Format format = (Format) Assertions.checkNotNull(this.inputFormat);
        List<MediaCodecInfo> decoderInfos = getDecoderInfos(this.mediaCodecSelector, format, z9);
    ...
    private void initCodec(MediaCodecInfo mediaCodecInfo, MediaCrypto mediaCrypto) throws Exception {
        ...
        MediaCodecAdapter.Configuration mediaCodecConfiguration = getMediaCodecConfiguration(mediaCodecInfo, format, mediaCrypto, f5);
        if (i2 >= 31) {
    ...
    private void maybeInitCodecWithFallback(MediaCrypto mediaCrypto, boolean z9) throws DecoderInitializationException {
        Format format = (Format) Assertions.checkNotNull(this.inputFormat);
        if (this.availableCodecInfos == null) {
            try {
                List<MediaCodecInfo> availableCodecInfos = getAvailableCodecInfos(z9);
    ...
    public abstract MediaCodecAdapter.Configuration getMediaCodecConfiguration(MediaCodecInfo mediaCodecInfo, Format format, MediaCrypto mediaCrypto, float f5);
    ...
    public final void maybeInitCodecOrBypass() throws ExoPlaybackException {
        ...
        if (this.codecDrmSession == null || initMediaCryptoIfDrmSessionReady()) {
            try {
                ...
                throw createRendererException(e10, format, PlaybackException.ERROR_CODE_DECODER_INIT_FAILED);
            }
        }
        ...
        if (i10 != 0) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    ...
                    this.codecNeedsAdaptationWorkaroundBuffer = z9;
                    this.codecInputFormat = format;
                    if (z10 && !drainAndUpdateCodecDrmSessionV23()) {
                        i2 = 2;
                    }
    ...
    */
    ...
    public abstract boolean processOutputBuffer(long j10, long j11, MediaCodecAdapter mediaCodecAdapter, ByteBuffer byteBuffer, int i2, int i10, int i11, long j12, boolean z9, boolean z10, Format format) throws ExoPlaybackException;
    ...
    public void render(long j10, long j11) throws ExoPlaybackException {
        ...
        try {
            ...
            throw createRendererException(mediaCodecDecoderExceptionCreateDecoderException, this.inputFormat, z9, mediaCodecDecoderExceptionCreateDecoderException.errorCode == 1101 ? PlaybackException.ERROR_CODE_DECODING_RESOURCES_RECLAIMED : PlaybackException.ERROR_CODE_DECODING_FAILED);
        }
    }
    ...
    public static class DecoderInitializationException extends Exception {
        ...
        public DecoderInitializationException(Format format, Throwable th, boolean z9, int i2) {
            this("Decoder init failed: [" + i2 + "], " + format, th, format.sampleMimeType, z9, null, buildCustomDiagnosticInfo(i2), null);
        }
        ...
        public DecoderInitializationException(Format format, Throwable th, boolean z9, MediaCodecInfo mediaCodecInfo) {
            this("Decoder init failed: " + mediaCodecInfo.name + ", " + format, th, format.sampleMimeType, z9, mediaCodecInfo, Util.SDK_INT >= 21 ? getDiagnosticInfoV21(th) : null, null);
        }
