...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    private void maybeNotifyBandwidthSample(int i2, long j10, long j11) {
        if (i2 == 0 && j10 == 0 && j11 == this.lastReportedBitrateEstimate) {
            return;
        }
    ...
    @Override // androidx.media3.datasource.TransferListener
    public synchronized void onTransferEnd(DataSource dataSource, DataSpec dataSpec, boolean z9) throws Throwable {
        Throwable th;
        ...
        try {
            try {
                if (isTransferAtFullNetworkSpeed(dataSpec, z9)) {
                    ...
                    if (i2 > 0) {
                        this.slidingPercentile.addSample((int) Math.sqrt(j11), (j11 * 8000.0f) / i2);
    ...
    public static final class Builder {
        ...
        public Builder setInitialBitrateEstimate(String str) {
            this.initialBitrateEstimates = getInitialBitrateEstimatesForCountry(y8.a.o0(str));
            return this;
        }
    }

    private DefaultBandwidthMeter(Context context, Map<Integer, Long> map, int i2, Clock clock, boolean z9) {
        ...
        networkTypeObserver.register(new f(0, this));
    }
