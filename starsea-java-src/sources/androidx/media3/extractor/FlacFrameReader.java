...
public final class FlacFrameReader {
    ...
    private static boolean checkAndReadFirstSampleNumber(ParsableByteArray parsableByteArray, FlacStreamMetadata flacStreamMetadata, boolean z9, SampleNumberHolder sampleNumberHolder) {
        try {
    ...
    private static boolean checkChannelAssignment(int i2, FlacStreamMetadata flacStreamMetadata) {
        if (i2 <= 7) {
            return i2 == flacStreamMetadata.channels - 1;
        }
        return i2 <= 10 && flacStreamMetadata.channels == 2;
    }
    ...
    public static long getFirstSampleNumber(ExtractorInput extractorInput, FlacStreamMetadata flacStreamMetadata) throws IOException {
        ...
        if (checkAndReadFirstSampleNumber(parsableByteArray, flacStreamMetadata, z9, sampleNumberHolder)) {
