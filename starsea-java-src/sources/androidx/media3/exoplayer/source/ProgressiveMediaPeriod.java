...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    private final Runnable maybeFinishPrepareRunnable = new m(this, 1);
    private final Runnable onContinueLoadingRequestedRunnable = new m(this, 2);
    ...
    public static final class TrackId {
        ...
        public TrackId(int i2, boolean z9) {
            this.id = i2;
            this.isIcyTrack = z9;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public long getLargestQueuedTimestampUs(boolean z9) {
        long jMax = Long.MIN_VALUE;
        for (int i2 = 0; i2 < this.sampleQueues.length; i2++) {
            if (z9 || ((TrackState) Assertions.checkNotNull(this.trackState)).trackEnabledStates[i2]) {
    ...
    public void maybeFinishPrepare() {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            boolean z9 = zIsAudio || MimeTypes.isVideo(str);
            zArr[i2] = z9;
            ...
            trackGroupArr[i2] = new TrackGroup(Integer.toString(i2), formatBuild.copyWithCryptoType(this.drmSessionManager.getCryptoType(formatBuild)));
        }
    ...
    private boolean seekInsideBufferUs(boolean[] zArr, long j10) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (!(this.isSingleSample ? sampleQueue.seekTo(sampleQueue.getFirstIndex()) : sampleQueue.seekTo(j10, false)) && (zArr[i2] || !this.haveAudioVideoTracks)) {
                return false;
            }
        }
        return true;
    ...
    public void lambda$seekMap$1(SeekMap seekMap) {
        ...
        boolean z9 = !this.isLengthKnown && seekMap.getDurationUs() == C.TIME_UNSET;
        this.isLive = z9;
        this.dataType = z9 ? 7 : 1;
        if (this.prepared) {
    ...
    public void discardBuffer(long j10, boolean z9) {
        ...
        int length = this.sampleQueues.length;
        for (int i2 = 0; i2 < length; i2++) {
            this.sampleQueues[i2].discardTo(j10, z9, zArr[i2]);
        }
    }
    ...
    public int readData(int i2, FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, int i10) {
        if (suppressRead()) {
            return -3;
        }
        maybeNotifyDownstreamFormat(i2);
        int i11 = this.sampleQueues[i2].read(formatHolder, decoderInputBuffer, i10, this.loadingFinished);
        if (i11 == -3) {
    ...
    public void seekMap(final SeekMap seekMap) {
        this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.n
            @Override // java.lang.Runnable
            public final void run() {
                this.f1337i.lambda$seekMap$1(seekMap);
            }
        });
    }
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j10) {
        ...
        boolean z9 = !this.seenFirstTrackSelection ? j10 == 0 || this.isSingleSample : i2 != 0;
    ...
    public int skipData(int i2, long j10) {
        if (suppressRead()) {
            return 0;
        }
        maybeNotifyDownstreamFormat(i2);
    ...
    public void onLoadCanceled(ExtractingLoadable extractingLoadable, long j10, long j11, boolean z9) {
    ...
    @Override // androidx.media3.exoplayer.upstream.Loader.Callback
    public Loader.LoadErrorAction onLoadError(ExtractingLoadable extractingLoadable, long j10, long j11, IOException iOException, int i2) {
