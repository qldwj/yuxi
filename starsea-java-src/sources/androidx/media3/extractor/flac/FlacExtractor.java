...
public final class FlacExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new b(25);
    ...
    private long findFrame(ParsableByteArray parsableByteArray, boolean z9) {
    ...
    private int readFrames(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        long jFindFrame = findFrame(this.buffer, z9);
