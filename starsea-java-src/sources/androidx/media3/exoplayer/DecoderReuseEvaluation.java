...
public final class DecoderReuseEvaluation {
    ...
    public DecoderReuseEvaluation(String str, Format format, Format format2, int i2, int i10) {
    ...
    public int hashCode() {
        return this.newFormat.hashCode() + ((this.oldFormat.hashCode() + h0.j0.r((((527 + this.result) * 31) + this.discardReasons) * 31, 31, this.decoderName)) * 31);
    }
}
