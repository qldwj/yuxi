...
final class SpannedToHtmlConverter {
    ...
    public static final class SpanInfo {
        ...
        private SpanInfo(int i2, int i10, String str, String str2) {
            this.start = i2;
            this.end = i10;
            this.openingTag = str;
    ...
    public static HtmlAndCss convert(CharSequence charSequence, float f5) {
        t1 t1Var = t1.f2594o;
        if (charSequence == null) {
            return new HtmlAndCss("", t1Var);
        }
        if (!(charSequence instanceof Spanned)) {
            return new HtmlAndCss(escapeHtml(charSequence), t1Var);
        }
        ...
        while (it.hasNext()) {
            ...
            map.put(HtmlUtils.cssAllClassDescendantsSelector(j0.v(iIntValue, "bg_")), Util.formatInvariant("background-color:%s;", HtmlUtils.toCssRgba(iIntValue)));
        }
        SparseArray<Transition> sparseArrayFindSpanTransitions = findSpanTransitions(spanned, f5);
    ...
    private static SparseArray<Transition> findSpanTransitions(Spanned spanned, float f5) {
    ...
    private static String getClosingTag(Object obj) {
        ...
        if (obj instanceof StyleSpan) {
            ...
            if (obj instanceof RubySpan) {
                return a2.b.H(new StringBuilder("<rt>"), escapeHtml(((RubySpan) obj).rubyText), "</rt></ruby>");
            }
    ...
    private static String getOpeningTag(Object obj, float f5) {
        ...
        if (obj instanceof AbsoluteSizeSpan) {
            ...
            return Util.formatInvariant("<span style='font-size:%.2fpx;'>", Float.valueOf(absoluteSizeSpan.getDip() ? absoluteSizeSpan.getSize() : absoluteSizeSpan.getSize() / f5));
        }
    ...
    private static String getTextEmphasisStyle(int i2, int i10) {
