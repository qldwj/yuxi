...
class DefaultDrmSession implements DrmSession {
    ...
    public class RequestHandler extends Handler {
        ...
        public void post(int i2, Object obj, boolean z9) {
            obtainMessage(i2, new RequestTask(LoadEventInfo.getNewId(), z9, SystemClock.elapsedRealtime(), obj)).sendToTarget();
        }
    ...
    public DefaultDrmSession(UUID uuid, ExoMediaDrm exoMediaDrm, ProvisioningManager provisioningManager, ReferenceCountListener referenceCountListener, List<DrmInitData.SchemeData> list, int i2, boolean z9, boolean z10, byte[] bArr, HashMap<String, String> map, MediaDrmCallback mediaDrmCallback, Looper looper, LoadErrorHandlingPolicy loadErrorHandlingPolicy, PlayerId playerId) {
        if (i2 == 1 || i2 == 3) {
    ...
    private void onKeysError(Throwable th, boolean z9) {
    ...
    private void postKeyRequest(byte[] bArr, int i2, boolean z9) {
        try {
            this.currentKeyRequest = this.mediaDrm.getKeyRequest(bArr, this.schemeDatas, i2, this.keyRequestParameters);
            ((RequestHandler) Util.castNonNull(this.requestHandler)).post(2, Assertions.checkNotNull(this.currentKeyRequest), z9);
