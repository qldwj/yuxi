...
public final class VorbisUtil {
    ...
    public static final class Mode {
        ...
        public Mode(boolean z9, int i2, int i10, int i11) {
            this.blockFlag = z9;
            this.windowType = i2;
    ...
    public static final class VorbisIdHeader {
        ...
        public VorbisIdHeader(int i2, int i10, int i11, int i12, int i13, int i14, int i15, int i16, boolean z9, byte[] bArr) {
            this.version = i2;
            this.channels = i10;
            this.sampleRate = i11;
    ...
    public static Metadata parseVorbisComments(List<String> list) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            ...
            if (strArrSplitAtFirst.length != 2) {
                a2.b.N("Failed to parse Vorbis comment: ", str, TAG);
    ...
    public static o0 parseVorbisCsdFromEsdsInitializationData(byte[] bArr) {
        ...
        int unsignedByte = parsableByteArray.readUnsignedByte() + i2;
        int i10 = 0;
        while (parsableByteArray.bytesLeft() > 0 && parsableByteArray.peekUnsignedByte() == 255) {
            i10 += 255;
            parsableByteArray.skipBytes(1);
    ...
    public static boolean verifyVorbisHeaderCapturePattern(int i2, ParsableByteArray parsableByteArray, boolean z9) throws ParserException {
    ...
    public static CommentHeader readVorbisCommentHeader(ParsableByteArray parsableByteArray, boolean z9, boolean z10) throws ParserException {
        if (z9) {
