...
public final class c0 extends p8.j implements v8.e {
    ...
    public final /* synthetic */ int f11968m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public /* synthetic */ Object f11969n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ f0 f11970o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public final /* synthetic */ String f11971p;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ c0(String str, f0 f0Var, n8.c cVar, int i2) {
        super(2, cVar);
        this.f11968m = i2;
        this.f11971p = str;
        this.f11970o = f0Var;
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        return ((c0) m(b0Var, cVar)).p(j8.n.f9120a);
    }
    ...
    public final n8.c m(Object obj, n8.c cVar) {
        switch (this.f11968m) {
            case 0:
                c0 c0Var = new c0(this.f11971p, this.f11970o, cVar, 0);
                c0Var.f11969n = obj;
                return c0Var;
            case 1:
                c0 c0Var2 = new c0(this.f11970o, this.f11971p, cVar);
                c0Var2.f11969n = obj;
                return c0Var2;
            default:
                c0 c0Var3 = new c0(this.f11971p, this.f11970o, cVar, 2);
                c0Var3.f11969n = obj;
                return c0Var3;
        }
    }
    ...
    public final Object p(Object obj) throws EOFException {
        ...
        b8.d dVar;
        int i2 = this.f11968m;
        f0 f0Var = this.f11970o;
        String str2 = this.f11971p;
        switch (i2) {
            case 0:
                da.a.c0(obj);
                l5.b bVar = new l5.b();
                bVar.r("https://pan.quark.cn/account/info");
                bVar.o("Cookie", str2);
            ...
            case 1:
                da.a.c0(obj);
                try {
                    o9.z zVarF2 = f0Var.d().b(f0.a(f0Var, "https://drive-pc.quark.cn/1/clouddrive/member?pr=ucpro&fr=pc&fetch_subscribe=true&_ch=home", str2)).f();
                    try {
            ...
            default:
                da.a.c0(obj);
                l5.b bVar2 = new l5.b();
                bVar2.r("https://drive-pc.quark.cn/1/clouddrive/config?pr=ucpro&fr=pc");
                Set set = g0.f12025a;
                w8.k.e("cookie", str2);
                ...
                bVar2.o("Cookie", k8.n.z0(arrayList2, "; ", null, null, null, 62));
                bVar2.o("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) quark-cloud-drive/2.5.20 Chrome/100.0.4896.160 Electron/18.3.5.12-a038f7b798 Safari/537.36 Channel/pckk_other_ch");
                bVar2.o("Referer", "https://pan.quark.cn/");
                bVar2.j();
                try {
                    o9.z zVarF3 = f0Var.d().b(bVar2.h()).f();
                    try {
                        Set set2 = g0.f12025a;
                        objF3 = g0.a(str2, zVarF3.f11342n.g());
                        if (!w8.k.a(objF3, str2) && (dVar = f0Var.f12015b) != null) {
                            dVar.invoke(objF3);
                        }
                        zVarF3.close();
                        break;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c0(f0 f0Var, String str, n8.c cVar) {
        super(2, cVar);
        this.f11968m = 1;
        this.f11970o = f0Var;
        this.f11971p = str;
