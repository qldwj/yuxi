...
public final class MpeghReader implements ElementaryStreamReader {
    ...
    private void copyData(ParsableByteArray parsableByteArray, ParsableByteArray parsableByteArray2, boolean z9) {
    ...
    private void finalizeFrame() {
        ...
        double d2 = (((double) (this.standardFrameLength - this.truncationSamples)) * 1000000.0d) / ((double) this.samplingRate);
    ...
    private void parseConfig(ParsableBitArray parsableBitArray) throws ParserException {
        ...
        if (j10 != j11) {
            ...
            int i2 = mpegh3daConfig.profileLevelIndication;
            String strConcat = i2 != -1 ? "mhm1".concat(String.format(".%02X", Integer.valueOf(i2))) : "mhm1";
            byte[] bArr = mpegh3daConfig.compatibleProfileLevelSet;
            this.output.format(new Format.Builder().setId(this.formatId).setSampleMimeType(MimeTypes.AUDIO_MPEGH_MHM1).setSampleRate(this.samplingRate).setCodecs(strConcat).setInitializationData((bArr == null || bArr.length <= 0) ? null : o0.o(Util.EMPTY_BYTE_ARRAY, bArr)).build());
        }
