...
public final class CachedRegionTracker implements Cache.Listener {
    ...
    public synchronized int getRegionEndTimeMs(long j10) {
        ...
        if (regionFloor != null) {
            ...
            if (j10 <= j11 && (i2 = regionFloor.endOffsetIndex) != -1) {
                ChunkIndex chunkIndex = this.chunkIndex;
                if (i2 == chunkIndex.length - 1) {
                    if (j11 == chunkIndex.offsets[i2] + ((long) chunkIndex.sizes[i2])) {
                        return -2;
                    }
                }
                return (int) ((chunkIndex.timesUs[i2] + (((j11 - chunkIndex.offsets[i2]) * chunkIndex.durationsUs[i2]) / ((long) chunkIndex.sizes[i2]))) / 1000);
            }
        }
        return -1;
    }
