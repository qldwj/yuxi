...
public final class SphericalGLSurfaceView extends GLSurfaceView {
    ...
    public final class Renderer implements GLSurfaceView.Renderer, TouchTracker.Listener, OrientationListener.Listener {
        ...
        private float calculateFieldOfViewInYDirection(float f5) {
            if (f5 > 1.0f) {
                return (float) (Math.toDegrees(Math.atan(Math.tan(Math.toRadians(45.0d)) / ((double) f5))) * 2.0d);
            }
            return 90.0f;
        }
        ...
        public synchronized void onOrientationChange(float[] fArr, float f5) {
        ...
        public void onSurfaceChanged(GL10 gl10, int i2, int i10) {
            ...
            float f5 = i2 / i10;
            Matrix.perspectiveM(this.projectionMatrix, 0, calculateFieldOfViewInYDirection(f5), f5, 0.1f, SphericalGLSurfaceView.Z_FAR);
        }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture) {
        this.mainHandler.post(new s(this, 5, surfaceTexture));
    }
    ...
    public void onDetachedFromWindow() {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.video.spherical.b
            ...
            public final void run() {
                this.f1389i.lambda$onDetachedFromWindow$0();
            }
        });
    }
