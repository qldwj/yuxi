...
public class TrackSelectionView extends LinearLayout {
    ...
    public interface TrackSelectionListener {
        void onTrackSelectionChanged(boolean z9, Map<TrackGroup, TrackSelectionOverride> map);
    }
    ...
    public static Map<TrackGroup, TrackSelectionOverride> filterOverrides(Map<TrackGroup, TrackSelectionOverride> map, List<Tracks.Group> list, boolean z9) {
        HashMap map2 = new HashMap();
        for (int i2 = 0; i2 < list.size(); i2++) {
            TrackSelectionOverride trackSelectionOverride = map.get(list.get(i2).getMediaTrackGroup());
            if (trackSelectionOverride != null && (z9 || map2.isEmpty())) {
    ...
    private void onTrackViewClicked(View view) {
        ...
        if (trackSelectionOverride == null) {
            ...
            this.overrides.put(mediaTrackGroup, new TrackSelectionOverride(mediaTrackGroup, o0.n(Integer.valueOf(i2))));
            return;
        }
        ...
        boolean z9 = zShouldEnableAdaptiveSelection || shouldEnableMultiGroupSelection();
        if (zIsChecked && z9) {
        ...
        for (int i2 = 0; i2 < this.trackViews.length; i2++) {
            ...
            while (true) {
                ...
                if (i10 < checkedTextViewArr.length) {
                    if (trackSelectionOverride != null) {
                        this.trackViews[i2][i10].setChecked(trackSelectionOverride.trackIndices.contains(Integer.valueOf(((TrackInfo) Assertions.checkNotNull(checkedTextViewArr[i10].getTag())).trackIndex)));
                    } else {
    ...
    private void updateViews() {
        ...
        for (int i2 = 0; i2 < this.trackGroups.size(); i2++) {
            ...
            for (int i12 = 0; i12 < i10; i12++) {
                ...
                this.trackViews[i2][i12] = checkedTextView;
    ...
    public void init(List<Tracks.Group> list, boolean z9, Map<TrackGroup, TrackSelectionOverride> map, final Comparator<Format> comparator, TrackSelectionListener trackSelectionListener) {
        this.isDisabled = z9;
