...
public final class jb implements v8.g {

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public final /* synthetic */ int f5058i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public final /* synthetic */ h8.f3 f5059j;

    public /* synthetic */ jb(h8.f3 f3Var, int i2) {
        this.f5058i = i2;
        this.f5059j = f3Var;
    }
    ...
    public final Object f(Object obj, Object obj2, Object obj3, Object obj4) {
        ...
        final h8.f3 f3Var = this.f5059j;
        v0.p0 p0Var = v0.l.f15818a;
        switch (i2) {
            case 0:
                h8.w2 w2Var = (h8.w2) obj2;
                v0.m mVar = (v0.m) obj3;
                ((Number) obj4).intValue();
                h1.i iVar = h1.b.f7202m;
                w8.k.e("$this$AnimatedContent", (v.h) obj);
                w8.k.e(CmcdData.Factory.STREAMING_FORMAT_SS, w2Var);
                if (w2Var instanceof h8.v2) {
                    v0.q qVar = (v0.q) mVar;
                    qVar.V(594542692);
                    ...
                    qVar.p(true);
                    qVar.p(false);
                } else if (w2Var instanceof h8.t2) {
                    ...
                    r0.z7.b(((h8.t2) w2Var).f8363a, null, ((r0.b1) qVar2.k(r0.d1.f13079a)).f12945s, 0L, null, 0L, null, 0L, 0, false, 0, 0, null, qVar2, 0, 0, 131066);
                    qVar2.p(true);
                    qVar2.p(false);
                } else {
                    if (!(w2Var instanceof h8.u2)) {
                        throw v0.n.d(594542376, (v0.q) mVar, false);
                    }
                    v0.q qVar3 = (v0.q) mVar;
                    qVar3.V(1251506225);
                    List list = ((h8.u2) w2Var).f8396a;
                    ...
                    if (arrayList.isEmpty()) {
                        ...
                        qVar3.V(594589225);
                        boolean zH = qVar3.h(arrayList) | qVar3.h(f3Var);
                        Object objM = qVar3.M();
                        if (zH || objM == p0Var) {
                            z9 = false;
                            final boolean z11 = false ? 1 : 0;
                            v8.c cVar = new v8.c() { // from class: f8.hb
                                @Override // v8.c
                                public final Object invoke(Object obj8) {
                                    ...
                                    switch (z11) {
                                        case 0:
                                            ...
                                            jVar.a(arrayList2.size(), new androidx.room.g(q4Var, 26, arrayList2), new e2.t0(15, arrayList2), new d1.d(-632812321, new ib(arrayList2, f3Var, 0), true));
                                            break;
                                        default:
                                            w8.k.e("$this$LazyColumn", jVar);
                                            kb kbVar = new kb(0);
                                            ArrayList arrayList3 = arrayList;
                                            jVar.a(arrayList3.size(), new androidx.room.g(kbVar, 27, arrayList3), new e2.t0(16, arrayList3), new d1.d(-632812321, new ib(arrayList3, f3Var, 1), true));
                                            break;
                                    }
                                    return j8.n.f9120a;
                                }
                ...
                return nVar;
            default:
                h8.w2 w2Var2 = (h8.w2) obj2;
                v0.m mVar2 = (v0.m) obj3;
                ((Number) obj4).intValue();
                h1.i iVar5 = h1.b.f7202m;
                w8.k.e("$this$AnimatedContent", (v.h) obj);
                w8.k.e(CmcdData.Factory.STREAMING_FORMAT_SS, w2Var2);
                if (w2Var2 instanceof h8.v2) {
                    ...
                    qVar4.p(true);
                    qVar4.p(false);
                } else if (w2Var2 instanceof h8.t2) {
                    ...
                    r0.z7.b(((h8.t2) w2Var2).f8363a, null, ((r0.b1) qVar5.k(r0.d1.f13079a)).f12945s, 0L, null, 0L, new a3.i(3), 0L, 0, false, 0, 0, ((r0.g8) qVar5.k(r0.h8.f13398a)).f13334k, qVar5, 0, 0, 65018);
                    b0.c.a(androidx.compose.foundation.layout.c.e(nVar2, 8), qVar5);
                    qVar5.V(555243410);
                    boolean zH2 = qVar5.h(f3Var);
                    Object objM2 = qVar5.M();
                    if (zH2 || objM2 == p0Var) {
                        objM2 = new va(f3Var, 8);
                        qVar5.f0(objM2);
                    }
                    qVar5.p(false);
                    r0.t2.l((v8.a) objM2, null, false, null, null, null, x4.f6093b, qVar5, 805306368, 510);
                    h0.j0.G(qVar5, true, true, false);
                } else {
                    if (!(w2Var2 instanceof h8.u2)) {
                        throw v0.n.d(-1078594833, (v0.q) mVar2, false);
                    }
                    v0.q qVar6 = (v0.q) mVar2;
                    qVar6.V(924508973);
                    List list2 = ((h8.u2) w2Var2).f8396a;
                    ...
                    if (arrayList2.isEmpty()) {
                        ...
                        qVar6.V(-1078522808);
                        boolean zH3 = qVar6.h(arrayList2) | qVar6.h(f3Var);
                        Object objM3 = qVar6.M();
                        if (zH3 || objM3 == p0Var) {
                            obj6 = objM3;
                            final int i17 = 1;
                            v8.c cVar2 = new v8.c() { // from class: f8.hb
                                @Override // v8.c
                                public final Object invoke(Object obj9) {
                                    ...
                                    switch (i17) {
                                        case 0:
                                            ...
                                            jVar.a(arrayList3.size(), new androidx.room.g(q4Var, 26, arrayList3), new e2.t0(15, arrayList3), new d1.d(-632812321, new ib(arrayList3, f3Var, 0), true));
                                            break;
                                        default:
                                            w8.k.e("$this$LazyColumn", jVar);
                                            kb kbVar = new kb(0);
                                            ArrayList arrayList4 = arrayList2;
                                            jVar.a(arrayList4.size(), new androidx.room.g(kbVar, 27, arrayList4), new e2.t0(16, arrayList4), new d1.d(-632812321, new ib(arrayList4, f3Var, 1), true));
                                            break;
                                    }
                                    return j8.n.f9120a;
                                }
