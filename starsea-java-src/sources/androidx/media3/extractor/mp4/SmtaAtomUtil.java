...
public final class SmtaAtomUtil {
    ...
    private static int getCaptureFrameRate(int i2, ParsableByteArray parsableByteArray, int i10) {
        if (i2 == 12) {
        ...
        if (i2 == 21 && parsableByteArray.bytesLeft() >= 8 && parsableByteArray.getPosition() + 8 <= i10) {
    ...
    public static Metadata parseSmta(ParsableByteArray parsableByteArray, int i2) {
        ...
        while (parsableByteArray.getPosition() < i2) {
            ...
            if (parsableByteArray.readInt() == 1935766900) {
                ...
                int captureFrameRate = getCaptureFrameRate(i11, parsableByteArray, i2);
