...
final class ProjectionRenderer {
    ...
    public void draw(int i2, float[] fArr, boolean z9) {
        float[] fArr2;
        MeshData meshData = z9 ? this.rightMeshData : this.leftMeshData;
        if (meshData == null) {
            return;
        }
        int i10 = this.stereoMode;
        if (i10 == 1) {
            fArr2 = z9 ? TEX_MATRIX_BOTTOM : TEX_MATRIX_TOP;
        } else if (i10 == 2) {
            fArr2 = z9 ? TEX_MATRIX_RIGHT : TEX_MATRIX_LEFT;
        } else {
    ...
    public void init() {
        try {
            ...
            Log.e(TAG, "Failed to initialize the program", e10);
        }
    }
    ...
    public void shutdown() {
        ...
        if (glProgram != null) {
            try {
                ...
                Log.e(TAG, "Failed to delete the shader program", e10);
            }
        }
    }
}
