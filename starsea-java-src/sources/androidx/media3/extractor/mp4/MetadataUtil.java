...
final class MetadataUtil {
    ...
    private static ApicFrame parseCoverArt(ParsableByteArray parsableByteArray) {
        ...
        if (str == null) {
            b.M("Unrecognized cover art flags: ", TAG, fullAtomFlags);
            return null;
        }
    ...
    public static Metadata.Entry parseIlstElement(ParsableByteArray parsableByteArray) {
        int i2 = parsableByteArray.readInt() + parsableByteArray.getPosition();
        int i10 = parsableByteArray.readInt();
        int i11 = (i10 >> 24) & 255;
        try {
            if (i11 == TYPE_TOP_BYTE_COPYRIGHT || i11 == TYPE_TOP_BYTE_REPLACEMENT) {
                ...
                if (i10 == TYPE_INTERNAL) {
                    Id3Frame internalAttribute = parseInternalAttribute(parsableByteArray, i2);
                    parsableByteArray.setPosition(i2);
    ...
    private static TextInformationFrame parseIndexAndCountAttribute(int i2, String str, ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == 1684108385 && i10 >= 22) {
            ...
            if (unsignedShort > 0) {
                String strV = j0.v(unsignedShort, "");
                int unsignedShort2 = parsableByteArray.readUnsignedShort();
                if (unsignedShort2 > 0) {
                    strV = strV + "/" + unsignedShort2;
                }
                return new TextInformationFrame(str, (String) null, o0.n(strV));
            }
        }
    ...
    private static Id3Frame parseIntegerAttribute(int i2, String str, ParsableByteArray parsableByteArray, boolean z9, boolean z10) {
        ...
        if (integerAttribute >= 0) {
            return z9 ? new TextInformationFrame(str, (String) null, o0.n(Integer.toString(integerAttribute))) : new CommentFrame(C.LANGUAGE_UNDETERMINED, str, Integer.toString(integerAttribute));
        }
    ...
    private static TextInformationFrame parseStandardGenreAttribute(ParsableByteArray parsableByteArray) {
        ...
        if (strResolveV1Genre != null) {
            return new TextInformationFrame("TCON", (String) null, o0.n(strResolveV1Genre));
        }
    ...
    private static TextInformationFrame parseTextAttribute(int i2, String str, ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == 1684108385) {
            parsableByteArray.skipBytes(8);
            return new TextInformationFrame(str, (String) null, o0.n(parsableByteArray.readNullTerminatedString(i10 - 16)));
        }
    ...
    public static void setFormatMetadata(int i2, Metadata metadata, Format.Builder builder, Metadata... metadataArr) {
